...
function listFrontierServerTests(repoRoot) {
    return listMatchingTestFiles(path.join(repoRoot, "server", "tests"), (name) => /^frontier.*\.test\.js$/i.test(name));
}
function listFrontierStaticTests(repoRoot) {
    return listMatchingTestFiles(path.join(repoRoot, "tools", "frontier-static", "test"), (name) => name.endsWith(".test.mjs"));
}
module.exports = {
...
//# sourceMappingURL=frontier-test-files.js.map