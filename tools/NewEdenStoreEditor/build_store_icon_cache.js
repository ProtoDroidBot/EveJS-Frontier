...
const outputPath = path.join(repoRoot, "server/src/gameStore/data/itemIcons/data.json");
...
async function main(explicitSnapshotDir = process.argv[2]) {
    ...
    process.stdout.write(`Seeded item icon cache with ${summary.iconCount} icon paths from ${summary.sourceSnapshot}.\n`);
...
//# sourceMappingURL=build_store_icon_cache.js.map