...
const { clientTypeListRecord, clientTypeListCounts, publicTypeRecord, typeRecord, } = require("../../DatabaseCreator/database-creator.js");
test("game-store records preserve Frontier typelist rules and type tags", () => {
    ...
    const type = typeRecord({ _key: 100, groupID: 10, name: { en: "Tagged type" }, tags: [213, 204] }, new Map([[10, { categoryID: 6, name: { en: "Group" } }]]), new Map([[6, { name: { en: "Ship" } }]]));
...
//# sourceMappingURL=type-list-audit.test.mjs.map