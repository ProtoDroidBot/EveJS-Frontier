...
const CUSTOM_DISCOVERABLE_CHANNELS = Object.freeze([
    Object.freeze({
        ...
        motd: "Welcome to EveJS Elysian. Fly dangerous, keep comms sharp, and help us forge full chat parity together.",
...
const VERIFIED_STATIC_CHANNELS = Object.freeze(Array.from(new Map([
    ROOKIE_HELP_CHANNEL,
    ...Object.values(HELP_CHANNEL_BY_LANGUAGE),
    ...PUBLIC_SYSTEM_CHANNELS,
].map((contract) => [contract.roomName, contract])).values()));
const DISCOVERABLE_STATIC_CHANNELS = Object.freeze(Array.from(new Map([
    ...CUSTOM_DISCOVERABLE_CHANNELS,
    ...VERIFIED_STATIC_CHANNELS,
].map((contract) => [contract.roomName, contract])).values()));
const STATIC_CHANNEL_BY_ROOM_NAME = Object.freeze(Object.fromEntries(DISCOVERABLE_STATIC_CHANNELS.map((contract) => [contract.roomName, contract])));
function getHelpChannelContract(languageID = "en") {
    const normalizedLanguage = normalizeLanguageCode(languageID);
    return cloneContract(HELP_CHANNEL_BY_LANGUAGE[normalizedLanguage] || HELP_CHANNEL_BY_LANGUAGE.en);
}
...
//# sourceMappingURL=staticChannelContracts.js.map