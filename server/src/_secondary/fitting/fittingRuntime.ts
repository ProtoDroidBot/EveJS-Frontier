...
function buildShipSnapshotCacheKey(characterID, shipReference, options: Record<string, any> = {}) {
  const shipID = toInt(
...
function normalizeSnapshotAttributes(attributes: Record<string, any> = {}) {
...
function buildRuntimeSnapshotRecord(characterID, shipReference, options: Record<string, any> = {}) {
...
function getShipFittingSnapshot(characterID, shipReference, options: Record<string, any> = {}) {
...
function refreshShipFittingSnapshot(characterID, shipReference, options: Record<string, any> = {}) {
...
function peekShipFittingSnapshot(characterID, shipReference, options: Record<string, any> = {}) {
  const cacheKey = buildShipSnapshotCacheKey(characterID, shipReference, options);
  if (!cacheKey) {
    return null;
  }
...
function invalidateShipFittingSnapshot(characterID, shipReference, options: Record<string, any> = {}) {
  const cacheKey = buildShipSnapshotCacheKey(characterID, shipReference, options);
  if (!cacheKey) {
    return null;
  }
