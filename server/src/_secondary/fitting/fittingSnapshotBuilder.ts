...
function resolveShipReferenceID(shipReference, options: Record<string, any> = {}) {
  return toInt(
...
function resolveSnapshotShipItem(characterID, shipReference, options: Record<string, any> = {}) {
...
function getSnapshotFittedItems(characterID, shipID, options: Record<string, any> = {}) {
...
function buildFittingSnapshot(characterID, shipReference, options: Record<string, any> = {}) {
