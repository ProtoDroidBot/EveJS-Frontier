...
const { DEFAULT_CHARACTER_PORTRAIT_PATH, findCharacterPortraitPath, } = require("../../services/character/portraitImageStore");
const { DEFAULT_FACTION_LOGO_PATH, findFactionLogoPath, } = require("../../services/faction/factionImageStore");
const { getFactionIDForCorporation, getFactionRecord, } = require("../../services/faction/factionState");
const { findAllianceLogoPath, } = require("../../services/corporation/allianceImageStore");
