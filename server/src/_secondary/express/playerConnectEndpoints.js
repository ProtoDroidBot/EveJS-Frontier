...
const CLIENT_START_INI_PATH = path.join(__dirname, "../../../../client/EVE/tq/start.ini");
...
function defaultLiveTokenReader() {
    ...
    return (snapshot && snapshot.resolvedConfig && snapshot.resolvedConfig.playerConnectToken);
}
...
function mountPlayerConnectEndpoints(app) {
    ...
    app.get("/playerconnect/ca.pem", (req, res) => {
        ...
        res.setHeader("Content-Disposition", 'attachment; filename="evejs-ca-cert.pem"');
...
//# sourceMappingURL=playerConnectEndpoints.js.map