...
const GRPC_RESPONSE_HEADERS: Record<string, any> = {
  ":status": 200,
...
function resolveNoticeRoutingState(streamState) {
  ...
  const routingState: Record<string, any> = {
...
function getObserverCharacterIDsForShip(shipID) {
  ...
  const observerCharacterIDs: any[] = [];
...
function resolveStructurePaintworkNoticeState(structureID, options: Record<string, any> = {}) {
...
function publishStructurePaintworkSetNotice(structureID, options: Record<string, any> = {}) {
