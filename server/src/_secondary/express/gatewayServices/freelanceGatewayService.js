...
function buildFreelanceProtoRoot() {
    ...
    root.define("google.protobuf").add(new protobuf.Type("Duration").add(new protobuf.Field("seconds", 1, "int64")));
    root.define("eve_public.isk").add(new protobuf.Type("Currency")
        .add(new protobuf.Field("units", 1, "uint64"))
        .add(new protobuf.Field("nanos", 2, "int32")));
    root.define("eve_public.freelance.project").add(new protobuf.Type("CreationPrices")
        .add(new protobuf.Field("base_fee_per_day", 1, "eve_public.isk.Currency"))
        .add(new protobuf.Field("broadcasting_fee_per_day_per_location", 2, "eve_public.isk.Currency")));
    root.define("eve_public.freelance.project.api").add(new protobuf.Type("GetCommitLimitsResponse")
        .add(new protobuf.Field("max_active_projects_per_participant", 1, "uint32"))
        .add(new protobuf.Field("max_committed_participants_per_project", 2, "uint32")));
    root.define("eve_public.freelance.project.api").add(new protobuf.Type("GetCreationLimitsResponse")
        .add(new protobuf.Field("max_active_projects_per_corporation", 1, "uint32"))
        .add(new protobuf.Field("max_active_projects_broadcast_per_system", 2, "uint32"))
        .add(new protobuf.Field("max_character_age_days", 3, "uint32"))
        .add(new protobuf.Field("max_broadcasting_locations_per_project", 4, "uint32"))
        .add(new protobuf.Field("max_committed_participants_per_project", 5, "uint32"))
        .add(new protobuf.Field("max_contribution_multiplier", 6, "double"))
        .add(new protobuf.Field("max_project_duration", 7, "google.protobuf.Duration")));
    root.define("eve_public.freelance.project.api").add(new protobuf.Type("GetCreationPricesResponse").add(new protobuf.Field("prices", 1, "eve_public.freelance.project.CreationPrices")));
    return root;
}
...
function createFreelanceGatewayService({ emptyPayload }) {
    ...
    const GetCommitLimitsResponse = protoRoot.lookupType("eve_public.freelance.project.api.GetCommitLimitsResponse");
    const GetCreationLimitsResponse = protoRoot.lookupType("eve_public.freelance.project.api.GetCreationLimitsResponse");
    const GetCreationPricesResponse = protoRoot.lookupType("eve_public.freelance.project.api.GetCreationPricesResponse");
    return {
        ...
        handleRequest(requestTypeName) {
            if (requestTypeName === "eve_public.freelance.project.api.GetCommitLimitsRequest") {
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.freelance.project.api.GetCommitLimitsResponse",
                    responsePayloadBuffer: encodePayload(GetCommitLimitsResponse, {
                        max_active_projects_per_participant: FREELANCE_LIMITS.maxActiveProjectsPerParticipant,
                        max_committed_participants_per_project: FREELANCE_LIMITS.maxCommittedParticipantsPerProject,
                    }),
                };
            }
            if (requestTypeName === "eve_public.freelance.project.api.GetCreationLimitsRequest") {
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.freelance.project.api.GetCreationLimitsResponse",
                    responsePayloadBuffer: encodePayload(GetCreationLimitsResponse, {
                        max_active_projects_per_corporation: FREELANCE_LIMITS.maxActiveProjectsPerCorporation,
                        max_active_projects_broadcast_per_system: FREELANCE_LIMITS.maxActiveProjectsBroadcastPerSystem,
                        max_character_age_days: FREELANCE_LIMITS.maxCharacterAgeDays,
                        max_broadcasting_locations_per_project: FREELANCE_LIMITS.maxBroadcastingLocationsPerProject,
                        max_committed_participants_per_project: FREELANCE_LIMITS.maxCommittedParticipantsPerProject,
                        max_contribution_multiplier: FREELANCE_LIMITS.maxContributionMultiplier,
            ...
            if (requestTypeName === "eve_public.freelance.project.api.GetCreationPricesRequest") {
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.freelance.project.api.GetCreationPricesResponse",
                    responsePayloadBuffer: encodePayload(GetCreationPricesResponse, {
                        prices: {
                            base_fee_per_day: buildCurrency(FREELANCE_CREATION_PRICES.baseFeePerDay),
                            broadcasting_fee_per_day_per_location: buildCurrency(FREELANCE_CREATION_PRICES.broadcastingFeePerDayPerLocation),
                        },
                    }),
                };
            }
...
//# sourceMappingURL=freelanceGatewayService.js.map