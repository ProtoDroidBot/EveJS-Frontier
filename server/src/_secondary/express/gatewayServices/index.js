...
const { createAssemblyGateGatewayService, } = require("./assemblyGateGatewayService");
const { createAssemblyNetworkNodeGatewayService, } = require("./assemblyNetworkNodeGatewayService");
const { createAssemblyStorageUnitGatewayService, } = require("./assemblyStorageUnitGatewayService");
const { createFrontierWalletGatewayService, } = require("./frontierWalletGatewayService");
const { createFrontierTokenExchangeGatewayService, } = require("./frontierTokenExchangeGatewayService");
...
const { createFwAdvantageGatewayService, } = require("./fwAdvantageGatewayService");
const { createInsurgencyGatewayService } = require("./insurgencyGatewayService");
const { createMercenaryDenGatewayService, } = require("./mercenaryDenGatewayService");
const { createLocalChatGatewayService, } = require("./localChatGatewayService");
const { createNewEdenStoreGatewayService, } = require("./newEdenStoreGatewayService");
const { createPlexVaultGatewayService } = require("./plexVaultGatewayService");
const { createSovereigntyGatewayService, } = require("./sovereigntyGatewayService");
const { createStructurePaintworkGatewayService, } = require("./structurePaintworkGatewayService");
const { createShipLogoGatewayService, } = require("./shipLogoGatewayService");
const { createSkillPlanGatewayService, } = require("./skillPlanGatewayService");
const { createCorpSkillPlanGatewayService, } = require("./corpSkillPlanGatewayService");
const { createMapTagsGatewayService, } = require("./mapTagsGatewayService");
const { createCampaignGatewayService, } = require("./campaignGatewayService");
const { createDailyGoalsGatewayService, } = require("./dailyGoalsGatewayService");
    ...
    return {
        ...
        getEmptySuccessResponseType(requestTypeName) {
            for (const service of services) {
                ...
                const responseTypeName = service.getEmptySuccessResponseType(requestTypeName);
                if (responseTypeName) {
