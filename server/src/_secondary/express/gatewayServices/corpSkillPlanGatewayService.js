...
const { encodePayload, getActiveCharacterID, uuidStringToBuffer, uuidBufferToString, } = require("./gatewayServiceHelpers");
const corpSkillPlanState = require(path.join(__dirname, "../../../services/skills/plans/corpSkillPlanState"));
const { getCorporationIDForCharacter, } = require(path.join(__dirname, "../../../services/corporation/corpColorsState"));
const { CORP_ROLE_DIRECTOR, getCorporationMember, toRoleMaskBigInt, } = require(path.join(__dirname, "../../../services/corporation/corporationRuntimeState"));
...
const RESPONSE_BY_REQUEST = Object.freeze({
    "eve_public.corporation.skill.plan.GetAllRequest": "eve_public.corporation.skill.plan.GetAllResponse",
    "eve_public.corporation.skill.plan.GetRequest": "eve_public.corporation.skill.plan.GetResponse",
    "eve_public.corporation.skill.plan.GetSharedRequest": "eve_public.corporation.skill.plan.GetSharedResponse",
    "eve_public.corporation.skill.plan.CreateRequest": "eve_public.corporation.skill.plan.CreateResponse",
    "eve_public.corporation.skill.plan.DeleteRequest": "eve_public.corporation.skill.plan.DeleteResponse",
    "eve_public.corporation.skill.plan.SetNameRequest": "eve_public.corporation.skill.plan.SetNameResponse",
    "eve_public.corporation.skill.plan.SetDescriptionRequest": "eve_public.corporation.skill.plan.SetDescriptionResponse",
    "eve_public.corporation.skill.plan.SetSkillRequirementsRequest": "eve_public.corporation.skill.plan.SetSkillRequirementsResponse",
    "eve_public.corporation.skill.plan.SetCategoryRequest": "eve_public.corporation.skill.plan.SetCategoryResponse",
    "eve_public.corporation.skill.plan.milestone.GetAllRequest": "eve_public.corporation.skill.plan.milestone.GetAllResponse",
    "eve_public.corporation.skill.plan.milestone.CreateRequest": "eve_public.corporation.skill.plan.milestone.CreateResponse",
    "eve_public.corporation.skill.plan.milestone.DeleteRequest": "eve_public.corporation.skill.plan.milestone.DeleteResponse",
    "eve_public.corporation.skill.plan.milestone.SetDescriptionRequest": "eve_public.corporation.skill.plan.milestone.SetDescriptionResponse",
});
...
function createCorpSkillPlanGatewayService(context) {
    ...
    const publishGatewayNotice = context && typeof context.publishGatewayNotice === "function"
        ? context.publishGatewayNotice
        : null;
    const lookup = (name) => protoRoot.lookupType(`eve_public.corporation.skill.plan.${name}`);
    const types = {
    ...
    function publishNotice(noticeTypeName, messageType, payload, corporationID) {
        ...
        publishGatewayNotice(noticeTypeName, encodePayload(messageType, payload), { corporation: Number(corporationID) });
    }
            ...
            try {
                if (requestTypeName === "eve_public.corporation.skill.plan.GetAllRequest") {
                    const plans = corporationID
                        ...
                        : [];
                    return ok(responseTypeName, encodePayload(types.getAllResponse, {
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.GetRequest") {
                    ...
                    const plan = corporationID
                        ? corpSkillPlanState.getCorpPlan(corporationID, extractPlanID(decoded.skill_plan))
                        : null;
                    if (!plan) {
                        return {
                            statusCode: 404,
                    ...
                    return ok(responseTypeName, encodePayload(types.getResponse, {
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.GetSharedRequest") {
                    ...
                    const shared = corpSkillPlanState.findCorpPlanByID(extractPlanID(decoded.skill_plan));
                    return ok(responseTypeName, encodePayload(types.getSharedResponse, shared ? { skill_plan: buildPlanAttributes(shared.plan) } : {}));
                }
                if (requestTypeName === "eve_public.corporation.skill.plan.CreateRequest") {
                    ...
                    publishNotice("eve_public.corporation.skill.plan.CreatedNotice", types.createdNotice, {
                        identifier: buildPlanIdentifier(created.planID),
                        skill_plan: buildPlanAttributes(created),
                    }, corporationID);
                    return ok(responseTypeName, encodePayload(types.createResponse, {
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.DeleteRequest") {
                    ...
                    publishNotice("eve_public.corporation.skill.plan.DeletedNotice", types.deletedNotice, { skill_plan: buildPlanIdentifier(planID) }, corporationID);
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.SetNameRequest") {
                    ...
                    publishNotice("eve_public.corporation.skill.plan.NameUpdatedNotice", types.nameUpdatedNotice, { identifier: buildPlanIdentifier(planID), name: String(decoded.name || "") }, corporationID);
                    return ok(responseTypeName);
                }
                if (requestTypeName === "eve_public.corporation.skill.plan.SetDescriptionRequest") {
                    ...
                    publishNotice("eve_public.corporation.skill.plan.DescriptionUpdatedNotice", types.descriptionUpdatedNotice, {
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.SetSkillRequirementsRequest") {
                    ...
                    const decoded = decodePayload(types.setSkillRequirementsRequest, requestEnvelope);
                    const planID = extractPlanID(decoded.skill_plan);
                    ...
                    publishNotice("eve_public.corporation.skill.plan.SkillRequirementsUpdatedNotice", types.skillRequirementsUpdatedNotice, {
                        identifier: buildPlanIdentifier(planID),
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.SetCategoryRequest") {
                    ...
                    publishNotice("eve_public.corporation.skill.plan.CategoryUpdatedNotice", types.categoryUpdatedNotice, {
                        identifier: buildPlanIdentifier(planID),
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.milestone.GetAllRequest") {
                    ...
                    const milestones = plan
                        ...
                        : [];
                    return ok(responseTypeName, encodePayload(types.milestoneGetAllResponse, {
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.milestone.CreateRequest") {
                    ...
                    const created = corpSkillPlanState.createCorpMilestone(corporationID, extractPlanID(milestoneData.skill_plan), {
                        description: milestoneData.description,
                        trainToTypeID: milestoneData.train_to_type &&
                            milestoneData.train_to_type.sequential,
                        skillTypeID: milestoneData.skill &&
                    ...
                    return ok(responseTypeName, encodePayload(types.milestoneCreateResponse, {
                ...
                if (requestTypeName === "eve_public.corporation.skill.plan.milestone.DeleteRequest") {
                    ...
                    corpSkillPlanState.deleteCorpMilestone(corporationID, decoded && decoded.milestone
                ...
                corpSkillPlanState.updateCorpMilestoneDescription(corporationID, decoded && decoded.identifier
                    ? uuidBufferToString(decoded.identifier.uuid)
                    : null, decoded.description);
                return ok(responseTypeName);
            }
            catch (error) {
...
//# sourceMappingURL=corpSkillPlanGatewayService.js.map