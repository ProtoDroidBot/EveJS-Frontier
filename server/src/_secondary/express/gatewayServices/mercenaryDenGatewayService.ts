...
function buildMercenaryActivityTemplatePayload(template: Record<string, any> = {}) {
  return {
...
function buildEvolutionPayload(evolution: Record<string, any> = {}) {
...
function buildInfomorphsPayload(infomorphs: Record<string, any> = {}) {
...
function buildMercenaryDenAttributesPayload(den: Record<string, any> = {}) {
  return {
...
function buildMercenaryActivityAttributesPayload(activity: Record<string, any> = {}) {
  return {
...
function buildMercenaryActivityEntryPayload(activity: Record<string, any> = {}) {
  return {
    id: {
...
function createMercenaryDenGatewayService({ publishGatewayNotice }: Record<string, any>) {
