...
const { MAP_TAGS_CDN_PATH, MAP_TAGS_CDN_URL, getMapTagsAsset, getMapTagsCrc, getMapTagsSummary, getMapTagsVersion, } = require(path.join(__dirname, "../../../services/map/mapTagsAuthority"));
const { bufferFromBytes, compareSemver, encodePayload, } = require("./gatewayServiceHelpers");
...
const MAP_TAGS_GET_UPDATE_RESPONSE_TYPE = "eve_public.space.api.cdn.GetUpdateResponse";
...
function decodeRequestPayload(requestEnvelope) {
    const payloadBuffer = bufferFromBytes(requestEnvelope && requestEnvelope.payload && requestEnvelope.payload.value);
...
//# sourceMappingURL=mapTagsGatewayService.js.map