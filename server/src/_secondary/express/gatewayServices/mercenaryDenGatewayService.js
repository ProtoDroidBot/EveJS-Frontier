...
const { encodePayload, getActiveCharacterID, timestampFromMs, uuidBufferToString, uuidStringToBuffer, } = require("./gatewayServiceHelpers");
const { getSovereigntyProtoTypes, } = require(path.join(__dirname, "../../../services/sovereignty/sovGatewayProto"));
const { getMercenaryActivityCapacity, getMercenaryDenActivities, getMercenaryDenAsOwner, getMercenaryDenMaximumForCharacter, listMercenaryDenActivitiesForCharacter, listOwnedMercenaryDenIDs, startMercenaryDenActivity, } = require(path.join(__dirname, "../../../services/sovereignty/mercenaryDenState"));
...
function decodePayload(messageType, requestEnvelope) {
    return messageType.decode(requestEnvelope && requestEnvelope.payload && requestEnvelope.payload.value
...
function buildEvolutionPayload(evolution = {}) {
    ...
    return {
        definition: {
            development: {
                unit_increase_time_seconds: Number(developmentDefinition.unitIncreaseTimeSeconds || 0),
            ...
            anarchy: {
                unit_increase_time_seconds: Number(anarchyDefinition.unitIncreaseTimeSeconds || 0),
        ...
        handleRequest(requestTypeName, requestEnvelope) {
            ...
            if (requestTypeName === "eve_public.sovereignty.mercenaryden.api.GetAllOwnedRequest") {
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.api.GetAllOwnedResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryDenGetAllOwnedResponse, {
                        id: listOwnedMercenaryDenIDs(activeCharacterID).map(buildSequentialIdentifier),
                    }),
                };
            }
            if (requestTypeName ===
                ...
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.api.GetMaximumForCharacterResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryDenGetMaximumForCharacterResponse, {
            ...
            if (requestTypeName === "eve_public.sovereignty.mercenaryden.api.GetAsOwnerRequest") {
                ...
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.api.GetAsOwnerResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryDenGetAsOwnerResponse, {
                        ...
                        skyhook_owner: buildSequentialIdentifier(result.den.skyhookOwnerCorporationID),
                    }),
                };
            }
            if (requestTypeName ===
                ...
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.activity.api.GetAllResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryActivityGetAllResponse, {
                        activities: listMercenaryDenActivitiesForCharacter(activeCharacterID).map(buildMercenaryActivityEntryPayload),
                    }),
                };
            }
            if (requestTypeName ===
                "eve_public.sovereignty.mercenaryden.activity.api.GetForMercenaryDenRequest") {
                const decoded = decodePayload(types.mercenaryActivityGetForDenRequest, requestEnvelope);
                const mercenaryDenID = Number(decoded && decoded.mercenary_den && decoded.mercenary_den.sequential) || 0;
                ...
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.activity.api.GetForMercenaryDenResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryActivityGetForDenResponse, {
                        activities: (result.activities || []).map(buildMercenaryActivityEntryPayload),
            ...
            if (requestTypeName ===
                ...
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.activity.api.GetCapacityResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryActivityGetCapacityResponse, {
            ...
            if (requestTypeName ===
                ...
                const activityID = uuidBufferToString(decoded && decoded.id && decoded.id.uuid ? decoded.id.uuid : Buffer.alloc(0));
                const result = startMercenaryDenActivity(activeCharacterID, activityID);
                if (!result.ok) {
                    return buildErrorResult(requestTypeName, result.statusCode, result.errorCode);
                }
                publishNotice("eve_public.sovereignty.mercenaryden.activity.api.StartedNotice", types.mercenaryActivityStartedNotice, {
                    id: {
                ...
                return {
                    statusCode: 200,
                    statusMessage: "",
                    responseTypeName: "eve_public.sovereignty.mercenaryden.activity.api.StartResponse",
                    responsePayloadBuffer: encodePayload(types.mercenaryActivityStartResponse, {
...
//# sourceMappingURL=mercenaryDenGatewayService.js.map