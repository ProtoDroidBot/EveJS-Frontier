...
const { getAssemblyGateProtoTypes, } = require("./assemblyGateProto");
const { listOwnedSmartGates, } = require(path.join(__dirname, "../../../services/frontier/deploymentRuntime"));
const { findItemById, getItemMetadata, } = require(path.join(__dirname, "../../../services/inventory/itemStore"));
...
const GET_ENERGY_CONFIG_REQUEST = "eve_public.assembly.api.GetEnergyConfigRequest";
const GET_ENERGY_CONFIG_RESPONSE = "eve_public.assembly.api.GetEnergyConfigResponse";
const GET_ALL_OWNED_REQUEST = "eve_public.assembly.gate.api.GetAllOwnedRequest";
const GET_ALL_OWNED_RESPONSE = "eve_public.assembly.gate.api.GetAllOwnedResponse";
...
function decodeMetadataAssemblyID(types, requestEnvelope) {
    try {
        const request = types.getMetadataRequest.decode(bufferFromBytes(requestEnvelope && requestEnvelope.payload && requestEnvelope.payload.value));
        ...
        handleRequest(requestTypeName, requestEnvelope) {
            ...
            if (characterID <= 0) {
                return {
                    ...
                    responseTypeName: requestTypeName === GET_METADATA_REQUEST
            ...
            if (requestTypeName === GET_METADATA_REQUEST) {
                ...
                return {
                    ...
                    statusMessage: "",
                    responseTypeName: GET_METADATA_RESPONSE,
                    responsePayloadBuffer: encodePayload(types.getMetadataResponse, { metadata }),
                };
            }
            return {
                statusCode: 200,
                ...
                responsePayloadBuffer: encodePayload(types.getAllOwnedResponse, {
...
//# sourceMappingURL=assemblyGateGatewayService.js.map