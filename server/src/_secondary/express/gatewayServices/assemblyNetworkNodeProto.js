...
function buildNetworkNodeProtoRoot() {
    ...
    root.define("eve_public.assembly").add(new protobuf.Type("Identifier").add(new protobuf.Field("sequential", 1, "uint64"))).add(new protobuf.Type("ItemAttributes")
    ...
    root.define("eve_public.assembly.networknode.fuel")
        .add(new protobuf.Type("Identifier").add(new protobuf.Field("sequential", 1, "uint64")))
        .add(new protobuf.Type("Attributes").add(new protobuf.Field("efficiency", 1, "uint64")));
    root.define("eve_public.assembly.networknode.fueltype").add(new protobuf.Type("Identifier").add(new protobuf.Field("sequential", 1, "uint64")));
    const fuelEntry = new protobuf.Type("FuelEntry")
        .add(new protobuf.Field("fuel", 1, "eve_public.assembly.networknode.fuel.Identifier"))
        .add(new protobuf.Field("attributes", 2, "eve_public.assembly.networknode.fuel.Attributes"))
        .add(new protobuf.Field("fuel_type", 3, "eve_public.assembly.networknode.fueltype.Identifier"))
        .add(new protobuf.Field("efficiency", 4, "uint64"));
    const depositFuelItem = new protobuf.Type("FuelItem")
        .add(new protobuf.Field("id", 1, "eve_public.assembly.networknode.fuel.Identifier"))
        .add(new protobuf.Field("quantity", 2, "uint32"));
    root.define("eve_public.assembly.networknode.api")
        .add(new protobuf.Type("GetFuelRequest").add(new protobuf.Field("network_node", 1, "eve_public.assembly.Identifier")))
        .add(new protobuf.Type("GetFuelResponse").add(new protobuf.Field("fuel", 1, "eve_public.assembly.ItemAttributes")))
        .add(new protobuf.Type("GetFuelConfigRequest"))
        .add(new protobuf.Type("GetFuelConfigResponse")
        .add(fuelEntry)
        .add(new protobuf.Field("fuels", 1, "eve_public.assembly.networknode.api.GetFuelConfigResponse.FuelEntry", "repeated")))
        .add(new protobuf.Type("PrepareDepositFuelRequest")
        .add(depositFuelItem)
        .add(new protobuf.Field("network_node", 1, "eve_public.assembly.Identifier"))
        .add(new protobuf.Field("source", 5, "eve_public.inventory.genericitem.Location"))
        .add(new protobuf.Field("items", 6, "eve_public.assembly.networknode.api.PrepareDepositFuelRequest.FuelItem", "repeated")))
        .add(new protobuf.Type("PrepareDepositFuelResponse")
        .add(new protobuf.Field("prepared_transaction_uuid", 1, "bytes"))
        .add(new protobuf.Field("prepared_transaction_bcs_data", 2, "bytes")))
        .add(new protobuf.Type("ExecuteDepositFuelRequest")
        .add(new protobuf.Field("prepared_transaction_uuid", 1, "bytes"))
        .add(new protobuf.Field("signature", 2, "string")))
        .add(new protobuf.Type("ExecuteDepositFuelResponse"))
        .add(new protobuf.Type("PrepareWithdrawFuelRequest")
        .add(new protobuf.Field("network_node", 1, "eve_public.assembly.Identifier"))
        .add(new protobuf.Field("fuel_type", 2, "eve_public.assembly.networknode.fueltype.Identifier"))
        .add(new protobuf.Field("quantity", 3, "uint32"))
        .add(new protobuf.Field("destination", 4, "eve_public.inventory.genericitem.Location")))
        .add(new protobuf.Type("PrepareWithdrawFuelResponse")
        .add(new protobuf.Field("prepared_transaction_uuid", 1, "bytes"))
        .add(new protobuf.Field("prepared_transaction_bcs_data", 2, "bytes")))
        .add(new protobuf.Type("ExecuteWithdrawFuelRequest")
        .add(new protobuf.Field("prepared_transaction_uuid", 1, "bytes"))
        .add(new protobuf.Field("signature", 2, "string")))
        .add(new protobuf.Type("ExecuteWithdrawFuelResponse"))
        .add(new protobuf.Type("FuelChangedNotice")
        .add(new protobuf.Field("network_node", 1, "eve_public.assembly.Identifier"))
...
//# sourceMappingURL=assemblyNetworkNodeProto.js.map