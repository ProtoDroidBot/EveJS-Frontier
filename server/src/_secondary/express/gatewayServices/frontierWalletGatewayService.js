...
function createFrontierWalletGatewayService(context = {}) {
    ...
    const getCharacterWallet = context.getFrontierCharacterWallet || require(path.join(__dirname, "../../../services/account/walletState")).getCharacterWallet;
    return {
        ...
        handleRequest(requestTypeName, requestEnvelope) {
            ...
            try {
                types.walletGetBalanceRequest.decode(bufferFromBytes(requestEnvelope &&
            ...
            return {
                ...
                statusMessage: "",
                responseTypeName: GET_BALANCE_RESPONSE,
                responsePayloadBuffer: encodePayload(types.walletGetBalanceResponse, {
                    balance: {
...
//# sourceMappingURL=frontierWalletGatewayService.js.map