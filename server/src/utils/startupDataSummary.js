...
const { readCatalog } = require(path.join(__dirname, "../services/ship/shipCosmeticsState"));
...
function countSkinOverrides(charactersByID) {
    ...
    for (const characterEntry of Object.values(charactersByID)) {
        total += countObjectEntries(characterEntry && characterEntry.skinOverridesBySkinID);
    }
    return total;
}
function buildStartupDataSummary() {
    ...
    return {
        ...
        cosmetics: {
            skins: normalizeCount(shipCosmeticsCatalog.counts && shipCosmeticsCatalog.counts.skins, countObjectEntries(shipCosmeticsCatalog.skinsBySkinID)),
            shipTypes: normalizeCount(shipCosmeticsCatalog.counts && shipCosmeticsCatalog.counts.shipTypes, countObjectEntries(shipCosmeticsCatalog.shipTypesByTypeID)),
            materials: normalizeCount(shipCosmeticsCatalog.counts && shipCosmeticsCatalog.counts.materials, countObjectEntries(shipCosmeticsCatalog.materialsByMaterialID)),
            licenseTypes: normalizeCount(shipCosmeticsCatalog.counts && shipCosmeticsCatalog.counts.licenseTypes, countObjectEntries(shipCosmeticsCatalog.licenseTypesByTypeID)),
        },
    };
}
...
//# sourceMappingURL=startupDataSummary.js.map