...
function normalizeRuntimeTickSample(sample: Record<string, any> = {}) {
...
function clearManualOverride(systemID, options: Record<string, any> = {}) {
  const normalizedSystemID = normalizeSystemID(systemID);
  if (normalizedSystemID <= 0) {
    return false;
  }
...
function scheduleAutoscaledFactorChange(factor, options: Record<string, any> = {}) {
...
function commitFactorChange(metrics, factor, options: Record<string, any> = {}) {
...
function evaluateWindowMetrics(metrics, options: Record<string, any> = {}) {
...
function observeRuntimeTickSampleInternal(sample, options: Record<string, any> = {}) {
...
function observeRuntimeTickSample(sample, options: Record<string, any> = {}) {
