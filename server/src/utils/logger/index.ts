...
const _stack: Record<string, any> = {
  key: null,
  line: null,
  count: 0,
  service: null,
...
function startupSection(title, rows: any[] = [], options: Record<string, any> = {}) {
  flushStack();
...
function criticalAlert(title, rows: any[] = [], options: Record<string, any> = {}) {
  flushStack();
