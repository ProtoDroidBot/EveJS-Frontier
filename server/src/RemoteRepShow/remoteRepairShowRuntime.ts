...
function resolveFirstTargetEntity(scene, controller, entry, candidates: any[] = []) {
...
function clearRemoteRepairShowFighters(scene, options: Record<string, any> = {}) {
...
function clearRemoteRepairShowController(scene, options: Record<string, any> = {}) {
...
function registerRemoteRepairShowController(scene, options: Record<string, any> = {}) {
  if (!scene) {
    return null;
  }
