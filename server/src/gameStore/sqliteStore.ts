...
const ROW_GROUPS: Record<string, any> = {
  notifications: ["boxes"],
 ...
 */
function explodeToRows(table, object: Record<string, any> = {}) {
 ...
 */
function assembleFromRows(table, rows: Record<string, any> = {}) {
...
function enqueuePersistenceOperation(table, upserts: any[] = [], deletes: any[] = []) {
 ...
 */
function applyChanges(table, upserts: any[] = [], deletes: any[] = []) {
 ...
 */
function replaceAll(table, object: Record<string, any> = {}) {
  ensureSqlTable(table);
