...
function migrate({ label, legacyDir, targetDir, filePattern }: Record<string, any>) {
  const result: Record<string, any> = { label, legacyDir, targetDir, moved: 0, skipped: 0, failed: 0 };
