...
function main() {
    ...
    if (unknown.length > 0) {
        console.error(`Not SQLite-backed runtime tables (skipping): ${unknown.join(", ")}`);
    }
    ...
    for (const table of tables) {
        ...
        console.log(`  + ${table.padEnd(28)} ${String(result.rows).padStart(6)} row(s)` +
...
main();
//# sourceMappingURL=migrateJsonToSqlite.js.map