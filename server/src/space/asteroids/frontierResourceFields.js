...
function normalizeTags(site) {
    return new Set((Array.isArray(site && site.featureTags) ? site.featureTags : [])
...
function buildFrontierResourceFieldDefinition(site) {
    ...
    const fieldSeed = ((itemID >>> 0) ^
        Math.imul(ecosystemID || 1, 0x9E3779B1)) >>> 0;
    return {
        itemID,
...
//# sourceMappingURL=frontierResourceFields.js.map