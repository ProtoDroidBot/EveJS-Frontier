...
function estimateMissileEffectiveRange(snapshot: Record<string, any> = {}) {
...
function estimateMissileFlightBudgetMs(snapshot: Record<string, any> = {}, sourceRadius = 0) {
...
function resolveMissileDamageReductionExponent(snapshot: Record<string, any> = {}) {
...
function resolveMissileApplicationFactor(snapshot: Record<string, any> = {}, impactState: Record<string, any> = {}) {
...
function resolveMissileAppliedDamage(snapshot: Record<string, any> = {}, targetEntity = null) {
