...
function queuePlayerMissileReload(session, moduleItem, chargeTypeID, options: Record<string, any> = {}) {
...
function queueNativeNpcMissileReload(entity, moduleItem, chargeTypeID, options: Record<string, any> = {}) {
...
function queueAutomaticMissileReload(options: Record<string, any> = {}) {
...
function resolvePendingMissileReload(entity, effectState, moduleItem, options: Record<string, any> = {}) {
  const reloadState =
