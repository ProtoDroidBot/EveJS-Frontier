...
function resolveAssistanceMultiplier(effectState, sourceEntity, targetEntity, callbacks: Record<string, any> = {}) {
...
function buildAssistanceModifierEntries(attributeMap, modifierSpecs: any[] = [], stackingPenalized = false) {
  const entries: any[] = [];
...
function buildNormalizedConditionState(targetEntity, callbacks: Record<string, any> = {}) {
