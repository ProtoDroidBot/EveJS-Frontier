...
function queuePlayerModuleReload(session, moduleItem, chargeTypeID, options: Record<string, any> = {}) {
...
function queueNativeNpcModuleReload(entity, moduleItem, chargeTypeID, options: Record<string, any> = {}) {
...
function queueAutomaticLocalModuleReload(options: Record<string, any> = {}) {
...
function resolvePendingLocalModuleReload(entity, effectState, moduleItem, options: Record<string, any> = {}) {
  const reloadState =
  ...
  if (reloadState.source === "nativeNpc") {
    const completionResult = completeNativeNpcLocalModuleReload(
      entity,
      moduleItem,
      reloadState,
    );
