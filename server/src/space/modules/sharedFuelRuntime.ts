...
function buildFuelFlagSet(fuelTypeID, priorityFlags: any[] = []) {
  return new Set<any>(getFuelStorageFlagsForType(fuelTypeID, priorityFlags));
}

function buildFuelFlagPriority(fuelTypeID, priorityFlags: any[] = []) {
...
function filterNativeStacksByFuelFlags(stacks, fuelTypeID, priorityFlags: any[] = []) {
...
function listCharacterFuelStacks(characterID, shipID, fuelTypeID, priorityFlags: any[] = []) {
...
function getFuelStacksForShipStorage(entity, fuelTypeID, callbacks: Record<string, any> = {}, priorityFlags: any[] = []) {
  const normalizedFuelTypeID = toInt(fuelTypeID, 0);
...
function getFuelQuantityFromStacks(stacks: any[] = []) {
...
function consumeFuelFromShipStorage(entity, fuelTypeID, quantity, callbacks: Record<string, any> = {}, priorityFlags: any[] = []) {
  const normalizedFuelTypeID = toInt(fuelTypeID, 0);
