...
function stopTractorTarget(scene, targetEntity, nowMs, options: Record<string, any> = {}) {
...
function handleTractorBeamDeactivation(scene, effectState, nowMs, options: Record<string, any> = {}) {
...
function tickScene(scene, nowMs, options: Record<string, any> = {}) {
  if (!scene) {
    return;
  }
