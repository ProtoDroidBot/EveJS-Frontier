...
function resolveModuleParityFamily(moduleItem, chargeItem = null) {
  ...
  let family: typeof MODULE_CLIENT_PARITY_FAMILIES[keyof typeof MODULE_CLIENT_PARITY_FAMILIES] = MODULE_CLIENT_PARITY_FAMILIES.generic;
