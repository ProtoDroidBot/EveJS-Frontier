...
function buildDunRotationFromNormalizedDirection(direction) {
    return coerceDunRotationTuple(geo2.buildDunRotationFromNormalizedDirection(direction));
}
...
function getStargateSystemForwardDirection(stargate, sourceSystem, destinationSystem) {
    ...
    return normalizeVector(subtractVectors(destinationSystem.position, sourceSystem.position));
}
function getResolvedStargateForwardDirection(stargate, sourceSystem, destinationSystem, fallback = null) {
...
function getResolvedStargateDunRotation(stargate, sourceSystem, destinationSystem) {
    return (coerceDunRotationTuple(stargate && stargate.dunRotation) ||
        buildDunRotationFromNormalizedDirection(getStargateSystemForwardDirection(stargate, sourceSystem, destinationSystem)));
}
module.exports = {
...
//# sourceMappingURL=stargateOrientation.js.map