...
const { readVec3, } = require("../../common/geo2");
const { CONCORD_FACTION_ID, EMPIRE_SENTRY_OFFSETS, GATE_SENTRY_DIAGONAL_METERS, GATE_SENTRY_RADIUS_METERS, getDisplayedSecurity, getEmpireSentryCountForSystem, getEmpireSentryLayout, getEmpireSentryTypeIDsForSystem, } = require("./empireSentryLayout");
...
//# sourceMappingURL=gateSceneryLayout.js.map