...
function major(offset, target) {
    return customsSlot(EVERMORE_CUSTOMS_MAJOR_TYPE_ID, offset, target, 1_500, MAJOR_SPEED_FRACTION);
}
function official(offset, target) {
    return customsSlot(EVERMORE_CUSTOMS_OFFICIAL_TYPE_ID, offset, target, 5_000, OFFICIAL_SPEED_FRACTION);
}
...
//# sourceMappingURL=everMoreGatePresence.js.map