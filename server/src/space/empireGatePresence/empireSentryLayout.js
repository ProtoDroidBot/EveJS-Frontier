...
const { readVec3, toFiniteNumber, } = require("../../common/geo2");
...
function getEmpireSentryTypeIDsForSystem(system) {
    ...
    return (SENTRY_TYPE_IDS_BY_FACTION_ID[factionID] ||
...
function getEmpireSentryLayout(system, options = {}) {
    ...
    const offsets = buildEmpireSentryOffsets(toFiniteNumber(options && options.distanceMeters, DEFAULT_EMPIRE_SENTRY_DISTANCE_METERS));
...
//# sourceMappingURL=empireSentryLayout.js.map