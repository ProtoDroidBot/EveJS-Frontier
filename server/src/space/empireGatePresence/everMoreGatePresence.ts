...
const BILLBOARD_OFFSET: Readonly<Vector3> = Object.freeze({ x: -18_000, y: 10_000, z: -28_000 });
...
function getConfiguredEverMoreGatePresenceSystemIDs(config: Record<string, any> = {}) {
...
function isEverMoreGatePresenceSystem(systemID, config: Record<string, any> = {}) {
