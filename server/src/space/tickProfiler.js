...
function logBreakdown() {
    ...
    log.info(`[TickProfile] last ${tickCount} ticks — ${(grandTotal / tickCount).toFixed(3)} ms/tick ${totalLabel} (sum across loaded scenes):\n${lines.join("\n")}`);
}
module.exports = { isEnabled, section, now, add, recordSceneTotal, tickBoundary };
//# sourceMappingURL=tickProfiler.js.map