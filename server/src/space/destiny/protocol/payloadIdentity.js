...
const { entityIDsEqual, normalizeEntityID: normalizeExactEntityID, } = require("../identity/entityID");
const { getCanonicalPayloadName, isDestinyPayload, } = require("./payloads");
...
const PRIMARY_ENTITY_PAYLOAD_NAMES = Object.freeze(Object.keys(PRIMARY_ENTITY_ARGUMENT_COUNTS));
...
function getPayloadPrimaryEntityIDOr(payload, fallback = 0, options = {}) {
...
function getAddBallsSlimEntityID(slimEntry) {
    ...
    const entityID = normalizeExactEntityID(getMarshalDictEntry(slimItem, "itemID"));
    return entityID === 0 || entityID === 0n ? null : entityID;
}
...
//# sourceMappingURL=payloadIdentity.js.map