...
function buildDestinyPresentationForSession(options: Record<string, any> = {}) {
...
function projectEntityForDestinyStamp(options: Record<string, any> = {}) {
...
function rebuildKinematicUpdatesForProjectedStamp(options: Record<string, any> = {}) {
  ...
  const stopVelocitySeedStamps = new Set<any>();
