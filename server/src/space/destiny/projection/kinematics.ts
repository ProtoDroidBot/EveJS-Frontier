...
function resolveMaxProjectionSteps(options: Record<string, any> = {}) {
...
function resolveProjectionStepMs(deltaMs, options: Record<string, any> = {}) {
...
function normalizeMovementTargetEntityIDs(entity, options: Record<string, any> = {}) {
  const resolver =
...
function projectEntityGraphToTime(options: Record<string, any> = {}) {
...
function projectEntityToTime(options: Record<string, any> = {}) {
