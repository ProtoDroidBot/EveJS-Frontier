...
function normalizeScene(options: Record<string, any> = {}) {
  return options.scene && typeof options.scene === "object"
    ? options.scene
    : {};
}

function resolveSceneBaseSimTimeMs(scene, options: Record<string, any> = {}) {
...
function resolveCommandSimTimeMs(scene, sceneBaseSimTimeMs, options: Record<string, any> = {}) {
...
function resolveMaxCommandProjectionStepMs(options: Record<string, any> = {}) {
  if (
...
function resolveMaxCommandProjectionSteps(options: Record<string, any> = {}) {
  if (
...
function getSceneEntityByID(scene, entityID, options: Record<string, any> = {}) {
...
function buildCommandTimeSurfaceState(options: Record<string, any> = {}) {
...
function getCommandTimeEntitySurfaceDistance(options: Record<string, any> = {}) {
...
function isWithinCommandTimeSurfaceRange(options: Record<string, any> = {}) {
