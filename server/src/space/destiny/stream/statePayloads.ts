...
function encodeStateHeader(packetType, stamp, deps: Record<string, any> = {}) {
...
function buildStateBuffer(packetType, stamp, entities, deps: Record<string, any> = {}) {
...
function buildAddBallsStateBuffer(stamp, entities, deps: Record<string, any> = {}) {
...
function buildSetStateBuffer(stamp, entities, deps: Record<string, any> = {}) {
...
function buildAddBallsExtraBallData(ballEntities, simFileTime, deps: Record<string, any> = {}) {
...
function buildSetStatePayload(
  ...
  entities,
  simFileTime = currentFileTime(),
  dbuffStateEntries: any[] = [],
  effectStateEntries: any[] = [],
  deps: Record<string, any> = {},
) {
