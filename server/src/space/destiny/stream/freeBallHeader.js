...
const { parseEntityIDBigInt, requireEntityID, } = require("../identity/entityID");
const { pushBigInt64, pushInt32, } = require("./primitives");
...
function resolveDestinyHarmonic(entity) {
    const value = entity && (entity.harmonic ??
        entity.harmonicID ??
        entity.mHarmonic);
...
//# sourceMappingURL=freeBallHeader.js.map