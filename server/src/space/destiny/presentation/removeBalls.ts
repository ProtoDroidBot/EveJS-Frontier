...
function resolvePresentationStamp(options: Record<string, any> = {}) {
...
function buildRemoveBallsPresentationUpdates(options: Record<string, any> = {}) {
...
function buildTerminalDestructionRemoveBallsPresentationUpdates(options: Record<string, any> = {}) {
