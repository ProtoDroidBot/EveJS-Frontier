...
function shouldReplayActiveSpecialFxForFreshAcquire(effectState, options: Record<string, any> = {}) {
...
function buildFreshAcquireActiveSpecialFxReplayUpdates(options: Record<string, any> = {}) {
  const toFiniteNumber =
    typeof options.toFiniteNumber === "function"
      ? options.toFiniteNumber
      : defaultToFiniteNumber;
...
function buildActiveSpecialFxEffectStateEntriesForSetState(options: Record<string, any> = {}) {
  const toFiniteNumber =
    typeof options.toFiniteNumber === "function"
      ? options.toFiniteNumber
      : defaultToFiniteNumber;
