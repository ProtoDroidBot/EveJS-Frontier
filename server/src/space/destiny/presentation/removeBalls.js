...
const { buildPackagedRemoveBallsUpdate, } = require("../batching/parkUpdateBatcher");
const { normalizeDestinyStamp, } = require("../delivery/stamps");
const { normalizeEntityID, } = require("../identity/entityID");
const { buildTerminalPlayDestructionEffectPayload, } = require("../stream/actions");
...
function buildRemoveBallsPresentationUpdates(options = {}) {
    ...
    if (!destiny || typeof destiny.buildRemoveBallsPayload !== "function") {
        throw new TypeError("buildRemoveBallsPresentationUpdates requires buildRemoveBallsPayload");
    }
...
function buildTerminalDestructionRemoveBallsPresentationUpdates(options = {}) {
    ...
    if (!Number.isFinite(terminalDestructionEffectID) ||
    ...
    return [
        {
            ...
            payload: buildTerminalPlayDestructionEffectPayload(normalizeEntityIDs(options.entityIDs)[0], terminalDestructionEffectID),
        },
        ...removeBallsUpdates,
    ];
}
...
//# sourceMappingURL=removeBalls.js.map