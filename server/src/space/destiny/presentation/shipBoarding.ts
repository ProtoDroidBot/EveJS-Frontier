...
function prepareHandoffInputs(options: Record<string, any> = {}) {
...
function buildPlan(stamp, payloads, options: Record<string, any> = {}) {
 ...
 */
function buildSameSceneShipBoardingHandoffPlan(options: Record<string, any> = {}) {
 ...
 * behavioral change.
 */
function buildSameSceneShipEjectHandoffPlan(options: Record<string, any> = {}) {
  const inputs = prepareHandoffInputs(options);
  if (!inputs) {
    return null;
  }
