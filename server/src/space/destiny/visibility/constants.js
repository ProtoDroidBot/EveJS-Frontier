...
const BUBBLE_CENTER_MIN_DISTANCE_SQUARED = BUBBLE_CENTER_MIN_DISTANCE_METERS * BUBBLE_CENTER_MIN_DISTANCE_METERS;
const BUBBLE_RETENTION_RADIUS_METERS = BUBBLE_RADIUS_METERS + BUBBLE_HYSTERESIS_METERS;
const BUBBLE_RETENTION_RADIUS_SQUARED = BUBBLE_RETENTION_RADIUS_METERS * BUBBLE_RETENTION_RADIUS_METERS;
