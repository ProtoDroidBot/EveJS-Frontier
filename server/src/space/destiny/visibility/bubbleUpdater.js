...
function runFinalSceneTickVisibilityCoordinator(options = {}) {
    ...
    const reconcileLanding = typeof options.reconcileLanding === "function"
        ...
        : null;
    const resolveWarpHandoffEntity = typeof options.resolveWarpHandoffEntity === "function"
        ? options.resolveWarpHandoffEntity
        : null;
    const reconcileWarpHandoff = typeof options.reconcileWarpHandoff === "function"
        ? options.reconcileWarpHandoff
        : null;
    const reconcileGenericSession = typeof options.reconcileGenericSession === "function"
...
//# sourceMappingURL=bubbleUpdater.js.map