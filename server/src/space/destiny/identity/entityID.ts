...
function normalizeEntityID(value, options: Record<string, any> = {}) {
...
function normalizePersistentEntityID(value, options: Record<string, any> = {}) {
  const parsed = parseEntityIDBigInt(value);
...
function normalizeNonNegativeInt64(value, options: Record<string, any> = {}) {
  const parsed = parseEntityIDBigInt(value);
  if (parsed === null || parsed < 0n) {
    return null;
  }
...
function getEntityMapKey(value, options: Record<string, any> = {}) {
  return normalizeEntityID(value, options);
}

function normalizeEntityIDSet(value, options: Record<string, any> = {}) {
...
function requireEntityID(value, label = "entityID", options: Record<string, any> = {}) {
...
function requirePersistentEntityID(value, label = "entityID", options: Record<string, any> = {}) {
...
function deriveEntityID(baseID, multiplier, offset = 0, options: Record<string, any> = {}) {
...
function toWireEntityID(value, options: Record<string, any> = {}) {
