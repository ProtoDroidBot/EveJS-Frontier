...
const VALID_DESTINY_CONTRACTS = new Set<string>(Object.values(DESTINY_CONTRACTS));

const CRITICAL_DESTINY_CONTRACTS = new Set<string>([
...
function inferDestinyContract(updates: any[] = [], options: Record<string, any> = {}) {
