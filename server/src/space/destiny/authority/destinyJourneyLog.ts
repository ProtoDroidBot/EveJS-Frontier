...
function buildStructuredLogRecord(event, details: Record<string, any> = {}) {
  return {
    event,
...
function createDestinyJourneyLog(deps: Record<string, any> = {}) {
  ...
  function logJourney(event, details: Record<string, any> = {}) {
    appendDestinyJourneyLog(JSON.stringify(
      normalizeStructuredLogRecord(event, details),
    ));
  }

  function logRestamp(event, details: Record<string, any> = {}) {
    appendNamedDebugLog(
      DESTINY_RESTAMP_LOG_PATH,
      "DestinyRestampLog",
      JSON.stringify(normalizeStructuredLogRecord(event, details)),
    );
  }

  function logEngine(event, details: Record<string, any> = {}) {
    appendNamedDebugLog(
  ...
  function logDrop(event, details: Record<string, any> = {}) {
    appendNamedDebugLog(
  ...
  function logMichelle(event, details: Record<string, any> = {}) {
    appendNamedDebugLog(
