...
function shouldRefreshOwnerCommandAnchor(options: Record<string, any> = {}) {
...
function resolveAtomicOwnerMovementLaneWrite(options: Record<string, any> = {}) {
...
function createMovementOwnerDispatch(deps: Record<string, any> = {}) {
  const {
