...
function createMovementContractDispatch(deps: Record<string, any> = {}) {
  const {
    cloneVector,
    isReadyForDestiny,
    logMissileDebug,
  ...
  return {
    ...
    dispatchSubwarpMovementUpdates(runtime, entity, updates, options: Record<string, any> = {}) {
    ...
    queueSubwarpMovementContract(runtime, entity, buildUpdates, options: Record<string, any> = {}) {
      if (!entity || typeof buildUpdates !== "function") {
        return false;
      }
