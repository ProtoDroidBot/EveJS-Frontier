  ...
  return Object.freeze({
    restore(targetScene, targetSession) {
      ...
      if (restored) {
        ...
        targetSession._space.visibleDynamicEntityIDs = new Set<any>(
          visibilitySnapshot.visibleDynamicEntityIDs,
        );
        targetSession._space.visibleBubbleScopedStaticEntityIDs = new Set<any>(
          visibilitySnapshot.visibleBubbleScopedStaticEntityIDs,
        );
        targetSession._space.freshlyVisibleDynamicEntityIDs = new Set<any>(
