...
function buildMichelleSafeDestinySendOptions(baseOptions: Record<string, any> = {}) {
...
function buildPresentedSessionAlignedDestinySendOptions(baseOptions: Record<string, any> = {}) {
  const minimumLeadFromCurrentHistory = Math.max(
    0,
    toInt(baseOptions.minimumLeadFromCurrentHistory, 0),
  );
...
function buildOwnerMissileLifecycleSendOptions(baseOptions: Record<string, any> = {}) {
...
function buildObserverMissileLifecycleSendOptions(baseOptions: Record<string, any> = {}) {
  return buildMichelleSafeDestinySendOptions({
    ...baseOptions,
...
function buildOwnerShipPrimeSendOptions(broadcastOptions: Record<string, any> = {}) {
  const baseOptions = {
    translateStamps:
      broadcastOptions &&
...
function buildOwnerCloakShipStateSendOptions(baseOptions: Record<string, any> = {}) {
...
function buildOwnerMissileFreshAcquireSendOptions(baseOptions: Record<string, any> = {}) {
  return buildMichelleSafeDestinySendOptions({
    ...baseOptions,
    destinyAuthorityContract: DESTINY_CONTRACTS.OWNER_MISSILE_LIFECYCLE,
...
function buildOwnerDamageStateSendOptions(baseOptions: Record<string, any> = {}) {
  return buildObserverCombatPresentedSendOptions({
    ...baseOptions,
  });
}

function buildObserverPropulsionShipPrimeBroadcastOptions(baseOptions: Record<string, any> = {}) {
  return {
    ...baseOptions,
...
function buildObserverPropulsionSpecialFxOptions(baseOptions: Record<string, any> = {}) {
  return buildMichelleSafeDestinySendOptions({
    ...baseOptions,
...
function buildMissileDeploymentSpecialFxOptions(baseOptions: Record<string, any> = {}) {
  return buildMichelleSafeDestinySendOptions({
    ...baseOptions,
    destinyAuthorityContract: DESTINY_CONTRACTS.COMBAT_NONCRITICAL,
    useCurrentStamp: true,
...
function buildObserverCombatPresentedSendOptions(baseOptions: Record<string, any> = {}) {
  return buildMichelleSafeDestinySendOptions({
    ...baseOptions,
    destinyAuthorityContract: DESTINY_CONTRACTS.COMBAT_NONCRITICAL,
    minimumHistoryLeadFloor: MICHELLE_HELD_FUTURE_DESTINY_LEAD,
...
function buildNpcOffensiveSpecialFxOptions(baseOptions: Record<string, any> = {}) {
  return buildObserverCombatPresentedSendOptions({
    ...baseOptions,
    useCurrentStamp: true,
  });
...
function buildObserverDamageStateSendOptions(baseOptions: Record<string, any> = {}) {
  return buildObserverCombatPresentedSendOptions(baseOptions);
}

function buildBootstrapAcquireSendOptions(baseOptions: Record<string, any> = {}) {
  return {
    ...baseOptions,
...
function buildStateResetSendOptions(baseOptions: Record<string, any> = {}) {
  return {
    ...baseOptions,
...
function buildDestructionTeardownSendOptions(baseOptions: Record<string, any> = {}) {
  return {
    ...baseOptions,
