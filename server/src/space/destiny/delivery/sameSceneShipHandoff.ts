...
function getSameSceneShipHandoffCapability(sendOptions: Record<PropertyKey, any> = {}) {
  const capability =
...
function getFollowingTeardownCapability(sendOptions: Record<PropertyKey, any> = {}) {
  const capability =
    sendOptions && typeof sendOptions === "object"
...
function buildSameSceneShipHandoffSendOptions(
  baseOptions: Record<PropertyKey, any> = {},
...
function buildFollowingTeardownSendOptions(options: Record<PropertyKey, any> = {}) {
...
function readFollowingTeardownCapability(sendOptions: Record<PropertyKey, any> = {}) {
...
function createSameSceneShipHandoffDeliveryScope(
  ...
  const scope: Record<PropertyKey, any> = {};
...
function getPureSingleRemoveBallsEntityID(updates: any[] = []) {
...
function recordSameSceneShipHandoffTransactionProof(options: Record<PropertyKey, any> = {}) {
  const {
    deliveryTransaction,
    finalStamp,
    originalStamp,
...
function authorizeFollowingTeardownTransaction(options: Record<PropertyKey, any> = {}) {
  const {
    deliveryTransaction,
    originalStamp,
