...
function applySuperweaponShowFollowMotionCommand({ entity, targetEntity, toInt, cloneVector, subtractVectors, normalizeVector, followRange, } = {}) {
    ...
    entity.direction = normalizeVector(subtractVectors(targetEntity.position, entity.position), entity.direction);
    return true;
}
module.exports = {
