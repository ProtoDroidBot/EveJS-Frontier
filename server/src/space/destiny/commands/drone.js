...
function createDroneOperationalMotionCommand({ droneEntity, mass, inertia, } = {}) {
    ...
    return {
        ...
        applyVelocityAndAgility({ maxVelocity, resolveAlignTime, maxAccelerationTime, resolveAgilitySeconds, } = {}) {
            if (!applied) {
                return false;
            }
