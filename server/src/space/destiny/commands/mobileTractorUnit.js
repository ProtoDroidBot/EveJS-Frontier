...
const { applyTractorActivationCommand, } = require("./tractorBeam.js");
const { buildOnSpecialFXPayload, } = require("../stream/actions");
function captureMobileTractorUnitPresentation({ scene, nowMs, } = {}) {
...
function applyMobileTractorUnitTractorStartCommand({ sourceEntity, targetEntity, tractorSpeedMetersPerSecond, followRangeMeters, effectGuid, effectDurationMs, effectRepeat, effectStartTime, } = {}) {
...
//# sourceMappingURL=mobileTractorUnit.js.map