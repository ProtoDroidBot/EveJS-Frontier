...
const { toJSONSafeEntityID, } = require("../identity/entityID");
const { clonePilotWarpMaxSpeedRamp, } = require("./warpRamp");
...
function serializeWarpState(entity) {
    ...
    return {
        ...
        warpDropoutSpeedMs: toFiniteNumber(entity.warpState.warpDropoutSpeedMs, toFiniteNumber(entity.warpState.warpFloorSpeedMs, 0)),
        ...
        accelExponent: toFiniteNumber(entity.warpState.accelExponent, DEFAULT_WARP_ACCEL_EXPONENT),
        decelExponent: toFiniteNumber(entity.warpState.decelExponent, DEFAULT_WARP_DECEL_EXPONENT),
        accelRate: toFiniteNumber(entity.warpState.accelRate, toFiniteNumber(entity.warpState.accelExponent, DEFAULT_WARP_ACCEL_EXPONENT)),
        decelRate: toFiniteNumber(entity.warpState.decelRate, toFiniteNumber(entity.warpState.decelExponent, DEFAULT_WARP_DECEL_EXPONENT)),
        ...
        startupGuidanceStamp: resolveOptionalDestinyStamp(entity.warpState.startupGuidanceStamp),
        startupGuidanceVelocity: cloneVector(entity.warpState.startupGuidanceVelocity, { x: 0, y: 0, z: 0 }),
        cruiseBumpAtMs: toFiniteNumber(entity.warpState.cruiseBumpAtMs, 0),
        cruiseBumpStamp: resolveOptionalDestinyStamp(entity.warpState.cruiseBumpStamp),
        ...
        destinationStaticInstanceID: serializeRuntimePersistentIdentity(entity.warpState, "destinationStaticInstanceID"),
        destinationDungeonRoomKey: String(entity.warpState.destinationDungeonRoomKey || "").trim() || null,
        destinationDungeonSiteID: serializeRuntimePersistentIdentity(entity.warpState, "destinationDungeonSiteID"),
        followID: toInt(entity.warpState.followID, 0),
        followRangeMarker: toFiniteNumber(entity.warpState.followRangeMarker, entity.warpState.stopDistance),
        ...
        pilotMaxSpeedRamp: clonePilotWarpMaxSpeedRamp(entity.warpState.pilotMaxSpeedRamp),
    };
}
function serializePendingWarp(pendingWarp) {
    ...
    const nativeWarpCommand = resolveSerializedNativeWarpCommand(pendingWarp.nativeWarpCommand);
    return {
        requestedAtMs: toInt(pendingWarp.requestedAtMs, 0),
        preWarpSyncStamp: resolveOptionalDestinyStamp(pendingWarp.preWarpSyncStamp),
        prepareStamp: resolveOptionalDestinyStamp(pendingWarp.prepareStamp),
        prepareVisibleStamp: resolveOptionalDestinyStamp(pendingWarp.prepareVisibleStamp),
        ...
        destinationStaticInstanceID: serializeRuntimePersistentIdentity(pendingWarp, "destinationStaticInstanceID"),
        destinationDungeonRoomKey: String(pendingWarp.destinationDungeonRoomKey || "").trim() || null,
        destinationDungeonSiteID: serializeRuntimePersistentIdentity(pendingWarp, "destinationDungeonSiteID"),
    };
}
...
Object.defineProperty(warpSerializationExports, "resolveWarpEffectDestinyStamp", {
    value: resolveWarpEffectDestinyStamp,
    enumerable: false,
});
module.exports = warpSerializationExports;
//# sourceMappingURL=warpSerialization.js.map