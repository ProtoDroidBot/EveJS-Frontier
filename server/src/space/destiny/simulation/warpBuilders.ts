...
function createDestinyWarpUpdateBuilders(deps: Record<string, any> = {}) {
  const {
    clamp,
    cloneVector,
  ...
  function buildWarpStartCommandUpdate(entity, stamp, warpState, options: Record<string, any> = {}) {
  ...
  function buildWarpPrepareDispatch(entity, stamp, warpState, options: Record<string, any> = {}) {
  ...
  function buildWarpCompletionUpdates(entity, stamp, options: Record<string, any> = {}) {
  ...
  function buildWarpStartUpdates(entity, warpState, stampOverride = null, options: Record<string, any> = {}) {
    const stamp =
      stampOverride === null
