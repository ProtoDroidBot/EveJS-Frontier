...
function createPythonRandom(seed) {
    ...
    return {
        random() {
            return (((genrandInt32() >>> 5) * 67108864 + (genrandInt32() >>> 6)) /
                9007199254740992);
        },
    };
}
...
function getPlanetWarpInPoint(target) {
    ...
    const factor = 20.0;
    let dd = Math.pow((factor - (5.0 * Math.log10(radius / 1000000)) - 0.5) / factor, factor) * factor;
...
//# sourceMappingURL=warpInPointParity.js.map