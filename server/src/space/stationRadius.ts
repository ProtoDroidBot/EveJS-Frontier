...
function resolveStationType(station, options: Record<string, any> = {}) {
...
function describeStationPhysicalRadius(station, options: Record<string, any> = {}) {
...
function resolveStationPhysicalRadius(station, options: Record<string, any> = {}) {
