...
function resolveCapitalClassID(entity, behaviorProfile: Record<string, any> = {}) {
...
function buildDoctrineForEntity(entity, behaviorProfile: Record<string, any> = {}) {
...
function resolveCapitalDoctrine(entity, behaviorProfile: Record<string, any> = {}) {
...
function resolveCapitalMovementDirective(entity, behaviorProfile, target, fallbackDirective: Record<string, any> = {}) {
