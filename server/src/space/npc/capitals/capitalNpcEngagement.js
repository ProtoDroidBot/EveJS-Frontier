...
function resolveCapitalEngagementPolicy(entity, controller, behaviorProfile, target, options = {}) {
    ...
    if (capitalState) {
        ...
        capitalState.lastPreferredRangeMeters = Math.max(0, toFiniteNumber(doctrine && doctrine.preferredCombatRangeMeters, 0));
...
//# sourceMappingURL=capitalNpcEngagement.js.map