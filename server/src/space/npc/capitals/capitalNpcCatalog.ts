...
function buildCommandTokenIndex(rows, idFieldName, extraAliasesByID: Record<string, any> = {}) {
  const exact = new Map();
  const ordered: any[] = [];
