...
function scoreCapitalTarget(entity, controller, candidate, options: Record<string, any> = {}) {
...
function selectBestScoredTarget(scoredCandidates: any[] = []) {
...
function resolveCapitalBehaviorTarget(scene, entity, controller, behaviorProfile, options: Record<string, any> = {}) {
