...
function rememberMovementState(capitalState, options: Record<string, any> = {}) {
  if (!capitalState) {
    return;
  }
...
function syncCapitalNpcMovement(scene, entity, controller, target, movementDirective, options: Record<string, any> = {}) {
...
function syncCapitalNpcReturnHome(scene, entity, controller, behaviorProfile, options: Record<string, any> = {}) {
