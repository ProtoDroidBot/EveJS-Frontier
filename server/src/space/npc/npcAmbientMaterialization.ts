...
function materializeAmbientStartupControllersForScene(scene, options: Record<string, any> = {}) {
  if (!scene) {
    return {
      success: false,
...
function canDematerializeAmbientStartupController(scene, controllerRecord, entity, options: Record<string, any> = {}) {
...
function dematerializeAmbientStartupControllersForScene(scene, options: Record<string, any> = {}) {
  if (!scene) {
    return {
      success: false,
      errorMsg: "SCENE_NOT_FOUND",
