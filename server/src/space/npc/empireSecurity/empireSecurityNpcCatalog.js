...
const { EVERMORE_CUSTOMS_CORPORATION_ID, EVERMORE_CUSTOMS_LOADOUT_ID, EVERMORE_CUSTOMS_MAJOR_PROFILE_ID, EVERMORE_CUSTOMS_MAJOR_TYPE_ID, EVERMORE_CUSTOMS_OFFICIAL_PROFILE_ID, EVERMORE_CUSTOMS_OFFICIAL_TYPE_ID, EVERMORE_CUSTOMS_SPAWN_GROUP_ID, EVERMORE_FACTION_ID, } = require("../../empireGatePresence/everMoreGatePresence");
...
function buildEverMoreGatePresenceRows() {
    const profileBase = {
        description: "TQ-observed EverMore/Villore Sec Ops gate-presence profile for Jita-style stargate security.",
        aliases: [],
    ...
    return {
        ...
        spawnGroups: [
            buildSpawnGroup(EVERMORE_CUSTOMS_SPAWN_GROUP_ID, "EverMore Gate Customs", "TQ-observed EverMore/Villore Sec Ops Jita-style customs chain for configured high-security stargates.", ENTITY_TYPE.CONCORD, [
                {
                    profileID: EVERMORE_CUSTOMS_MAJOR_PROFILE_ID,
                    count: 2,
                },
...
//# sourceMappingURL=empireSecurityNpcCatalog.js.map