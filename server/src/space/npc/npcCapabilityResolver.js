...
const { typeHasEffectName, isChargeCompatibleWithModule, selectAutoFitFlagForType, } = require(path.join(__dirname, "../../services/fitting/liveFittingState"));
...
function getNpcCapabilityTypeID(moduleItemOrTypeID, fallback = 0) {
    if (moduleItemOrTypeID && typeof moduleItemOrTypeID === "object") {
        const explicitCapabilityTypeID = toPositiveInt(moduleItemOrTypeID.npcCapabilityTypeID, 0);
...
//# sourceMappingURL=npcCapabilityResolver.js.map