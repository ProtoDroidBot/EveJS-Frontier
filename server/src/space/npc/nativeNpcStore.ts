...
function resolveStoredEntityScopeMetadata(sources: any[] = [], options: Record<string, any> = {}) {
  const sourceList = Array.isArray(sources) ? sources : [sources];
  const metadata: Record<string, any> = {};
  const invalidIdentityFields = new Set<any>();
  const conflictingIdentityFields = new Set<any>();
  ...
  const missingRequiredIdentityFields: any[] = [];
  if (
...
function validateStoredEntityScopeMetadata(value: Record<string, any> = {}, options: Record<string, any> = {}) {
  return resolveStoredEntityScopeMetadata([value], options);
}

function buildStoredEntityScopeMetadata(value: Record<string, any> = {}, options: Record<string, any> = {}) {
...
function allocateEntityID(options: Record<string, any> = {}) {
  return allocateID(TABLE.ENTITIES, "nextEntityID", options);
}

function allocateModuleID(options: Record<string, any> = {}) {
  return allocateID(TABLE.MODULES, "nextModuleID", options);
}

function allocateCargoID(options: Record<string, any> = {}) {
  return allocateID(TABLE.CARGO, "nextCargoID", options);
}

function allocateWreckID(options: Record<string, any> = {}) {
  return allocateID(TABLE.WRECKS, "nextWreckID", options);
}

function allocateWreckItemID(options: Record<string, any> = {}) {
  return allocateID(TABLE.WRECK_ITEMS, "nextWreckItemID", options);
}

function listNativeEntities() {
  return Object.values<any>(readCollection(TABLE.ENTITIES, "entities"))
...
function upsertNativeEntity(entityRecord, options: Record<string, any> = {}) {
...
function listNativeModules() {
  return Object.values<any>(readCollection(TABLE.MODULES, "modules"))
...
function listNativeCargo() {
  return Object.values<any>(readCollection(TABLE.CARGO, "cargo"))
...
function listNativeControllers() {
  ...
  const allControllers = Object.values<any>(readCollection(TABLE.CONTROLLERS, "controllers"))
    .sort((left, right) => Number(left.entityID || 0) - Number(right.entityID || 0));
...
function upsertNativeController(controllerRecord, options: Record<string, any> = {}) {
...
function listNativeWrecks() {
  return Object.values<any>(readCollection(TABLE.WRECKS, "wrecks"))
...
function upsertNativeWreck(wreckRecord, options: Record<string, any> = {}) {
...
function listNativeWreckItems() {
  return Object.values<any>(readCollection(TABLE.WRECK_ITEMS, "items"))
...
function upsertNativeWreckItem(wreckItemRecord, options: Record<string, any> = {}) {
