...
function buildVirtualAnchor(descriptor: Record<string, any> = {}) {
...
function filterCandidatesByDescriptor(candidates, descriptor: Record<string, any> = {}) {
...
function resolveAnchors(systemID, descriptor: Record<string, any> = {}) {
...
function resolveAnchor(systemID, descriptor: Record<string, any> = {}) {
...
function resolveSpawnDistance(anchorEntity, definition, options: Record<string, any> = {}) {
...
function buildSpawnStateForDefinition(anchorEntity, definition, options: Record<string, any> = {}) {
