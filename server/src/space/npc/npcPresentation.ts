...
function resolveNpcStandingThresholds(profile: Record<string, any> = {}) {
...
function buildNpcSlimPresentation(definition, shipLike: Record<string, any> = {}) {
...
function resolveNpcEntityRadius(shipType, presentationType, slimPresentation, profile: Record<string, any> = {}, shipLike: Record<string, any> = {}) {
...
function buildNpcEntityIdentity(definition, shipLike: Record<string, any> = {}) {
  const profile = definition && definition.profile
    ? definition.profile
    : {};
