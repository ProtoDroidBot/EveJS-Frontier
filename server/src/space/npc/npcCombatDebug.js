...
const NPC_COMBAT_DEBUG_PATH = path.join(__dirname, "../../../logs/space-npc-combat-debug.log");
...
function summarizeNpcCombatEntity(entity) {
    ...
    return {
        ...
        factionID: toInt(entity.npcFactionID ?? entity.factionID ?? entity.warFactionID, 0),
        factionKey: typeof entity.npcFactionKey === "string" ? entity.npcFactionKey : null,
...
//# sourceMappingURL=npcCombatDebug.js.map