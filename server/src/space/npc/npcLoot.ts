...
function getGenericLootPool() {
  ...
  cachedGenericLootPoolByTypeID = new Map<any, any>(
...
function selectorAllowsSpecialGrade(selector: Record<string, any> = {}) {
...
function itemMatchesTextFilters(itemType, selector: Record<string, any> = {}) {
...
function isRuleEligibleBaseItem(itemType, selector: Record<string, any> = {}) {
  return (
    itemType &&
...
function itemMatchesLootSelector(itemType, selector: Record<string, any> = {}) {
...
function getRuleSelectorCacheKey(selector: Record<string, any> = {}) {
...
function getRuleCandidatePool(selector: Record<string, any> = {}) {
...
function buildExplicitLootEntry(entrySpec: Record<string, any> = {}) {
...
function buildRuleLootEntry(itemType, selector: Record<string, any> = {}, lootTable: Record<string, any> = {}) {
  if (!itemType) {
    return null;
  }
...
function rollNpcLootEntriesInternal(lootTable = null, visitedBaseRuleIDs = new Set<any>()) {
  const pool = getGenericLootPool();
...
function rollNpcLootEntries(lootTable = null) {
  return rollNpcLootEntriesInternal(lootTable, new Set<any>());
}

function seedNpcShipLoot(characterID, shipID, lootTable = null, options: Record<string, any> = {}) {
