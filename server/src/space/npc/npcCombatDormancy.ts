...
function canDematerializeDormantCombatController(scene, controller, entity, options: Record<string, any> = {}) {
...
function materializeDormantCombatControllersForScene(scene, options: Record<string, any> = {}) {
  if (!scene) {
    return {
      success: false,
...
function dematerializeDormantCombatControllersForScene(scene, options: Record<string, any> = {}) {
  if (!scene) {
    return {
      success: false,
      errorMsg: "SCENE_NOT_FOUND",
