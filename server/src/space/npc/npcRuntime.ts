...
function estimateNpcWarpWakeAtMs(scene, options: Record<string, any> = {}) {
...
function startManagedNpcWarp(context, point, options: Record<string, any> = {}) {
...
function spawnBatchForSession(session, options: Record<string, any> = {}) {
  return npcService.spawnNpcBatchForSession(session, options);
}

function spawnBatchInSystem(systemID, options: Record<string, any> = {}) {
  return npcService.spawnNpcBatchInSystem(systemID, options);
}

function spawnWarpBatchForSession(session, options: Record<string, any> = {}) {
...
function spawnNpcForSession(session, options: Record<string, any> = {}) {
  return npcService.spawnNpcForSession(session, options);
}

function spawnConcordBatchForSession(session, options: Record<string, any> = {}) {
  return npcService.spawnConcordBatchForSession(session, options);
}

function spawnConcordForSession(session, options: Record<string, any> = {}) {
  return npcService.spawnConcordForSession(session, options);
}

function spawnGroupInSystem(systemID, options: Record<string, any> = {}) {
  return npcService.spawnNpcGroupInSystem(systemID, options);
}

function spawnSite(siteQuery, options: Record<string, any> = {}) {
...
function issueAttackOrder(entityID, targetID, options: Record<string, any> = {}) {
...
function stop(entityID, options: Record<string, any> = {}) {
...
function follow(entityID, targetEntityID, range = 0, options: Record<string, any> = {}) {
  const contextResult = resolveNpcContext(entityID);
  if (!contextResult.success || !contextResult.data) {
    return contextResult;
  }
...
function orbit(entityID, targetEntityID, distance, options: Record<string, any> = {}) {
  const contextResult = resolveNpcContext(entityID);
  if (!contextResult.success || !contextResult.data) {
    return contextResult;
  }
...
function warpToPoint(entityID, point, options: Record<string, any> = {}) {
  const contextResult = resolveNpcContext(entityID);
  if (!contextResult.success || !contextResult.data) {
    return contextResult;
  }
...
function warpToEntity(entityID, targetEntityID, options: Record<string, any> = {}) {
  const contextResult = resolveNpcContext(entityID);
  if (!contextResult.success || !contextResult.data) {
    return contextResult;
  }
...
function warpBatchToPoints(requests, options: Record<string, any> = {}) {
...
function despawn(entityID, options: Record<string, any> = {}) {
