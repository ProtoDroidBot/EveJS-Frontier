...
function buildDefinitionsForSpawnGroup(group, options: Record<string, any> = {}) {
...
function resolveNpcSpawnGroupPlan(query, options: Record<string, any> = {}) {
...
function resolveNpcSpawnPlan(query, options: Record<string, any> = {}) {
  const trimmedQuery = String(query || "").trim();
