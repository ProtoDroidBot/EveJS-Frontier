...
const SYSTEM_LISTS = deepFreeze(authorityRoot &&
    authorityRoot.systemLists &&
    typeof authorityRoot.systemLists === "object"
    ? authorityRoot.systemLists
    : {});
const SYSTEM_LISTS_BY_NORMALIZED_KEY = new Map(Object.entries(SYSTEM_LISTS).map(([key, list]) => [
...
//# sourceMappingURL=trigDrifterSpawnAuthority.js.map