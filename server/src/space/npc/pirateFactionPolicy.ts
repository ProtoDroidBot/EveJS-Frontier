...
function resolvePirateFactionForSystem(systemID, options: Record<string, any> = {}) {
  const numericSystemID = toInt(systemID, 0);
...
function resolvePirateFactionKeyForSystem(systemID, options: Record<string, any> = {}) {
...
function listTemplateSpawnQueries(template: Record<string, any> = {}) {
...
function resolveTemplatePirateFactionKeys(template: Record<string, any> = {}) {
