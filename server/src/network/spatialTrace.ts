...
function buildConfiguration(options: Record<string, any> = {}) {
...
function resolveClock(scene, options: Record<string, any> = {}) {
...
function recordEntitySpawn(scene, entity, options: Record<string, any> = {}) {
...
function recordWreckRecordCreated(scene, wreckRecord, details: Record<string, any> = {}) {
...
function recordTerminalState(scene, entity, options: Record<string, any> = {}) {
  if (!isEnabled() || !scene || !entity) {
    return null;
  }
...
function recordVisibilityEligibility(scene, session, entity, details: Record<string, any> = {}) {
  if (!isEnabled()) {
    return null;
  }
  const entityId = Number(entity && entity.itemID);
...
function recordVisibilityBoundary(scene, session, entity, details: Record<string, any> = {}) {
  if (!isEnabled()) {
    return null;
  }
...
function recordVisibilityDelta(scene, session, delta, details: Record<string, any> = {}) {
  if (!isEnabled() || !delta) {
    return 0;
  }
...
function recordDestinyActionAuthored(scene, session, update, details: Record<string, any> = {}) {
...
function recordDestinyPresentationEnqueue(scene, session, update, details: Record<string, any> = {}) {
  if (!isEnabled() || !update) {
    return null;
  }
...
function recordDestinyGroupEnqueued(scene, session, details: Record<string, any> = {}) {
...
function prepareDestinyNotification(scene, session, details: Record<string, any> = {}) {
...
function recordSerializedNotification(session, payloadTuple, buffer) {
  ...
  const packetContext: Record<string, any> = { ...context, packetId };
...
function recordNotificationSent(session, context, details: Record<string, any> = {}) {
...
function complete(details: Record<string, any> = {}) {
  if (!isEnabled()) {
    return null;
  }
...
function configureForTesting(options: Record<string, any> = {}) {
  closeCurrentOutput();
