...
function encodeTimeDilationBody({ baseTime, factor, eventTime }: Record<string, any>) {
...
function buildTimeDilationFrame(kind, options: Record<string, any> = {}) {
...
function buildTimeDilationNativeHeader(kind, options: Record<string, any> = {}) {
...
function buildTimeDilationInitFrame(options: Record<string, any> = {}) {
  return buildTimeDilationFrame(TIDI_KINDS.INIT, options);
}

function buildTimeDilationEventFrame(options: Record<string, any> = {}) {
  return buildTimeDilationFrame(TIDI_KINDS.EVENT, options);
}

function buildTimeDilationDetachFrame(options: Record<string, any> = {}) {
