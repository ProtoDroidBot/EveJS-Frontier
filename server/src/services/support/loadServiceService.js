...
const { buildDict, unwrapMarshalValue, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
let config = {
    pyStoneTasklets: 0,
    pyStonesPerSec: 0,
    pyStonesPerUnit: 0,
...
class LoadService extends BaseService {
    ...
    Handle_SetConfig(args) {
        ...
        config = {
            ...config,
            ...Object.fromEntries(Object.entries(incoming).filter(([, value]) => Number.isFinite(Number(value)))),
        };
...
//# sourceMappingURL=loadServiceService.js.map