...
const MINING_HOLD_DEFINITIONS_BY_FLAG = new Map(MINING_HOLD_DEFINITIONS.map((definition) => [definition.flagID, definition]));
...
//# sourceMappingURL=miningConstants.js.map