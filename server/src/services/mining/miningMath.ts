...
function computeMiningResult(options: Record<string, any> = {}) {
...
function computeAsteroidRadiusFromQuantity(typeID, quantity, options: Record<string, any> = {}) {
...
function computeAsteroidQuantityFromRadius(typeID, radius, options: Record<string, any> = {}) {
