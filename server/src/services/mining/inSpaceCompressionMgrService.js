...
const { compressInventoryItem, resolveInSpaceCompressionContext, } = require("./miningIndustry");
...
class InSpaceCompressionMgrService extends BaseService {
    ...
    Handle_CompressItemInSpace(args, session) {
        ...
        const contextResult = resolveInSpaceCompressionContext(session, facilityBallID);
        ...
        syncInventoryItemForSession(session, compressResult.data.change.item, compressResult.data.change.previousData || {}, {
...
//# sourceMappingURL=inSpaceCompressionMgrService.js.map