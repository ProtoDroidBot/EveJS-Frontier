...
function isIceProductTypeRecord(typeRecord) {
    return (toInt(typeRecord && typeRecord.groupID, 0) === ICE_PRODUCT_GROUP_ID ||
        getNormalizedGroupName(typeRecord) === "ice product");
}
function isFuelBlockTypeRecord(typeRecord) {
    return (toInt(typeRecord && typeRecord.groupID, 0) === FUEL_BLOCK_GROUP_ID ||
...
//# sourceMappingURL=fuelBayInventory.js.map