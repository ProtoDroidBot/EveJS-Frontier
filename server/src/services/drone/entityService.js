...
const { commandEngage, commandMineRepeatedly, commandSalvage, commandAbandonDrone, commandReconnectToDrones, commandReturnBay, commandReturnHome, } = require(path.join(__dirname, "./droneRuntime"));
