...
function buildDamageVector(attributes: Record<string, any> = {}) {
  return {
...
function sumDamageVector(vector: Record<string, any> = {}) {
  return round6(
...
function buildControllerDogmaFingerprint(controllerEntity, fittedItems: any[] = []) {
...
function buildActiveModuleContexts(controllerEntity, fittedItems: any[] = [], characterID = 0) {
...
function resolveDroneEffectRecord(typeID, acceptedNames = new Set<any>()) {
