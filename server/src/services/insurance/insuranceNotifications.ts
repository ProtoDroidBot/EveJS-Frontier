...
function createInsuranceNotification(characterID, typeID, data: Record<string, any> = {}, options: Record<string, any> = {}) {
...
function notifyInsuranceIssued(characterID, contract, options: Record<string, any> = {}) {
...
function notifyInsurancePayout(characterID, payoutAmount, options: Record<string, any> = {}) {
...
function notifyInsuranceInvalidated(characterID, reason, data: Record<string, any> = {}, options: Record<string, any> = {}) {
  return createInsuranceNotification(
    characterID,
...
function notifyInsuranceExpiration(characterID, data: Record<string, any> = {}, options: Record<string, any> = {}) {
  return createInsuranceNotification(
    characterID,
