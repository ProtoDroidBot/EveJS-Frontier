...
function getSkillLevelFromRecord(record) {
    ...
    const level = Number(record.effectiveSkillLevel ??
...
function getCharacterCloneLimit(characterID) {
    ...
    return (getCharacterSkillLevel(charID, TYPE_INFOMORPH_PSYCHOLOGY) +
...
function getCharacterCloneJumpCooldownHours(characterID) {
    const level = getCharacterSkillLevel(characterID, TYPE_INFOMORPH_SYNCHRONIZING);
...
//# sourceMappingURL=jumpCloneRules.js.map