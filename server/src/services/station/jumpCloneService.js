...
const { buildBoundObjectResponse, normalizeText, resolveBoundNodeId, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
...
class JumpCloneService extends BaseService {
    ...
    Handle_MachoBindObject(args, session, kwargs) {
        ...
        const nestedMethod = Array.isArray(nestedCall)
            ...
            : "";
        if (nestedMethod === "ValidateInstallJumpClone" &&
    ...
    Handle_SetJumpCloneName(args, session) {
        ...
        return jumpCloneRuntime.setJumpCloneName(session, args && args[0], args && args[1]);
    }
    ...
    Handle_CloneJump(args, session) {
        ...
        return jumpCloneRuntime.performCloneJump(session, args && args[0], args && args[1], args && args[2], args && args[3]);
    }
...
//# sourceMappingURL=jumpCloneService.js.map