...
const factionsWithShipcaster = new Set<any>();
const starterEligibleCharacterIDs = new Set<any>();
...
function normalizeLandingPad(rawLandingPad: Record<string, any> = {}) {
...
function buildLandingPadListPayload(landingPads: any[] = []) {
  return buildList(
    landingPads
...
function seedLandingPadsForTests(landingPads: any[] = []) {
...
function seedFactionsWithShipcasterForTests(factionIDs: any[] = []) {
...
function seedStarterEligibleCharactersForTests(characterIDs: any[] = []) {
