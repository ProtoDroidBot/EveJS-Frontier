...
function combineRoles(...roles: bigint[]): bigint {
  return roles.reduce(
...
function normalizeRoleValue(value, fallback = DEFAULT_CHAT_ROLE): bigint {
  try {
...
function buildPersistedAccountRoleRecord(account: Record<string, any> = {}) {
