...
function accumulateActionCounts(actionCounts, processed: any[] = []) {
...
function runDueOfficeRentalBillingCatchup(options: Record<string, any> = {}) {
...
function runStartupBillingMaintenance(options: Record<string, any> = {}) {
