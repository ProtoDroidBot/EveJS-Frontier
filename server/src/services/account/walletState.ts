...
const JOURNAL_ENTRY_TYPE: Record<string, any> = {
  PLAYER_TRADING: 1,
...
function resolveLedgerReason(options: Record<string, any> = {}, fallback = "No details given") {
...
function normalizeMarketTransactionEntry(entry: Record<string, any> = {}) {
...
function getCharacterWalletTransactions(charId, options: Record<string, any> = {}) {
...
function emitAccountChangeToSession(session, options: Record<string, any> = {}) {
...
function notifyCharacterWalletChange(charId, wallet, options: Record<string, any> = {}) {
...
function setCharacterBalance(charId, nextBalance, options: Record<string, any> = {}) {
...
function adjustCharacterBalance(charId, amount, options: Record<string, any> = {}) {
  const currentWallet = getCharacterWallet(charId);
  if (!currentWallet) {
    return {
      success: false as const,
...
function transferCharacterBalance(fromCharId, toCharId, amount, options: Record<string, any> = {}) {
...
function setCharacterPlexBalance(charId, nextBalance, options: Record<string, any> = {}) {
  const currentWallet = getCharacterWallet(charId);
  if (!currentWallet) {
    return {
      success: false as const,
...
function adjustCharacterPlexBalance(charId, amount, options: Record<string, any> = {}) {
  const currentWallet = getCharacterWallet(charId);
  if (!currentWallet) {
    return {
      success: false as const,
