...
const DAILY_TEMPLATE_BY_KEY = Object.freeze(Object.fromEntries(DAILY_TEMPLATE_POOL.map((t) => [t.key, t])));
...
const MONTHLY_MILESTONES = Object.freeze(["alpha", "omega"].flatMap((tier) => MONTHLY_MILESTONE_TARGETS.map((target) => ({
    key: `${tier}_${target}`,
    tier,
    omega: tier === "omega",
    target,
...
const MONTHLY_MILESTONE_BY_KEY = Object.freeze(Object.fromEntries(MONTHLY_MILESTONES.map((m) => [m.key, m])));
...
//# sourceMappingURL=dailyGoalsCatalog.js.map