...
function getCharacterCreationRaces(options: Record<string, any> = {}) {
...
function getCharacterCreationRace(raceID, options: Record<string, any> = {}) {
...
function getCharacterCreationBloodlines(options: Record<string, any> = {}) {
  if (options && options.refresh) {
...
function getCharacterCreationBloodline(bloodlineID, options: Record<string, any> = {}) {
...
function getCharacterCreationSchools(options: Record<string, any> = {}) {
  if (options && options.refresh) {
...
function getCharacterCreationSchool(schoolID, options: Record<string, any> = {}) {
...
function getCharacterCreationSchoolStartingSolarSystemID(schoolID, options: Record<string, any> = {}) {
  const school = getCharacterCreationSchool(schoolID, options);
  return toNumber(school && school.solarSystemID, 0) || null;
}

function getCharacterCreationQAStarterSystemIDs(options: Record<string, any> = {}) {
  return [...new Set<any>(
...
function resolveCharacterCreationSchoolProfile(schoolID, fallback: Record<string, any> = {}) {
  const numericSchoolID = toNumber(schoolID, 0);
...
function resolveCharacterCreationBloodlineProfile(bloodlineID, fallback: Record<string, any> = {}) {
  const numericBloodlineID = toNumber(bloodlineID, 0);
