...
function recordNpcFactionStandingLoss(victimEntity = {}, killerCharacterID, options = {}) {
    ...
    const systemID = toPositiveInt(options.systemID, toPositiveInt(victimEntity && victimEntity.systemID, 0));
    ...
    let result;
    try {
        result = standingRuntime.applyStandingChanges(characterID, [
            {
                ownerID: factionID,
                rawChange,
...
//# sourceMappingURL=factionKillStandingRuntime.js.map