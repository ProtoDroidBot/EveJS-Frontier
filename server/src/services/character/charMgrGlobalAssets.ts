...
class CharMgrGlobalAssets {
  ...
  _resolveRootLocation(item, itemById, session, caches: Record<string, any> = {}) {
    ...
    const visitedLocationIDs = new Set<any>();
    const traversedItemIDs: any[] = [];
