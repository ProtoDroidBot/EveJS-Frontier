...
function normalizePayload(payload = {}) {
    return {
        ...
        relationsByOwnerID: payload && typeof payload.relationsByOwnerID === "object"
    ...
    for (const [ownerID, relations] of Object.entries(payload.relationsByOwnerID || {})) {
        ...
        const normalizedRelations = Array.isArray(relations)
            ? relations
                ...
                propagationMultiplier: entry && Object.prototype.hasOwnProperty.call(entry, "propagationMultiplier")
...
//# sourceMappingURL=npcStandingsAuthority.js.map