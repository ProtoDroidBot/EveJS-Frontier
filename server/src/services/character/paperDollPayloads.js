...
function normalizePaperDollPayload(value) {
    ...
    if (Object.prototype.hasOwnProperty.call(value, "sculptLocationID") &&
...
function normalizePortraitDataForClient(value) {
    ...
    if (Object.prototype.hasOwnProperty.call(source, "cameraPosition")) {
        setVectorFields(portraitData, source.cameraPosition, ["cameraX", "cameraY", "cameraZ"], [
    ...
    if (Object.prototype.hasOwnProperty.call(source, "cameraPoi")) {
        setVectorFields(portraitData, source.cameraPoi, ["cameraPoiX", "cameraPoiY", "cameraPoiZ"], [
            DEFAULT_PORTRAIT_DATA.cameraPoiX,
            DEFAULT_PORTRAIT_DATA.cameraPoiY,
            DEFAULT_PORTRAIT_DATA.cameraPoiZ,
        ]);
    }
    const poseData = source.poseData &&
        typeof source.poseData === "object" &&
        !Array.isArray(source.poseData)
        ? source.poseData
        : null;
    if (poseData) {
        for (const [poseKey, portraitField] of Object.entries(POSE_DATA_TO_PORTRAIT_FIELD)) {
            if (!Object.prototype.hasOwnProperty.call(poseData, poseKey)) {
                continue;
            }
            if (portraitField === "portraitPoseNumber") {
                portraitData[portraitField] = normalizeInteger(poseData[poseKey], DEFAULT_PORTRAIT_DATA[portraitField]);
            }
            else {
                portraitData[portraitField] = normalizeNumber(poseData[poseKey], DEFAULT_PORTRAIT_DATA[portraitField]);
            }
        }
        if (Object.prototype.hasOwnProperty.call(poseData, "HeadLookTarget")) {
            setVectorFields(portraitData, poseData.HeadLookTarget, ["headLookTargetX", "headLookTargetY", "headLookTargetZ"], [
...
function getStoredAppearanceInfo(record = {}) {
    ...
    const appearanceInfo = record.appearanceInfo ??
        record.charInfo ??
...
function getStoredPortraitInfo(record = {}) {
    ...
    const portraitInfo = record.portraitInfo ??
...
function hasStoredAppearanceInfo(record = {}) {
    ...
    return (record.appearanceInfo !== undefined &&
        record.appearanceInfo !== null) || (record.charInfo !== undefined &&
        record.charInfo !== null) || (record.paperDollData !== undefined &&
...
//# sourceMappingURL=paperDollPayloads.js.map