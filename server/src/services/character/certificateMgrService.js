...
const { buildAllShipCertificateRecommendationsPayload, buildCertificateCategoriesPayload, buildCertificateClassesPayload, buildCharacterCertificatesRowsetForCharacter, buildMyCertificatesRowsetForCharacter, getCertificateDefinition, grantCertificates, updateCertificateVisibilityFlags, } = require(path.join(__dirname, "../skills/certificates/certificateRuntime"));
...
class CertificateMgrService extends BaseService {
    ...
    Handle_UpdateCertificateFlags(args, session) {
        ...
        log.debug(`[CertificateMgr] UpdateCertificateFlags(${characterID}, ${certificateID}, ${visibilityFlags})`);
    ...
    Handle_BatchCertificateGrant(args, session) {
        ...
        log.debug(`[CertificateMgr] BatchCertificateGrant(${characterID}, ${certificateIDs.length})`);
...
//# sourceMappingURL=certificateMgrService.js.map