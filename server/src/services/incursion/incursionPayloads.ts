...
function buildIncursionReportEntry(rawIncursion: Record<string, any> = {}) {
...
function buildIncursionGlobalReport(rawIncursions: any[] = []) {
...
function normalizeIncursionSystemRow(rawSystem: Record<string, any> = {}, defaultTemplateNameID = 0) {
...
function deriveSystemRowsFromIncursion(rawIncursion: Record<string, any> = {}) {
...
function buildSystemsInIncursionsRowset(rawIncursions: any[] = []) {
  const rows: any[] = [];
