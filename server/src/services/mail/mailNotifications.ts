...
function sendNotificationToCharacter(characterID, notifyType, payloadTuple, options: Record<string, any> = {}) {
...
function sendMailSentNotification(characterID, message, statusMask, options: Record<string, any> = {}) {
...
function sendMailDeletedNotification(characterID, messageIDs, options: Record<string, any> = {}) {
...
function sendMailTrashedNotification(characterID, messageIDs, options: Record<string, any> = {}) {
  sendNotificationToCharacter(characterID, "OnMailTrashed", [messageIDs], options);
}

function sendMailRestoredNotification(characterID, messageIDs, options: Record<string, any> = {}) {
  sendNotificationToCharacter(characterID, "OnMailRestored", [messageIDs], options);
}

function sendMailUndeletedNotification(characterID, messageIDs, options: Record<string, any> = {}) {
  sendNotificationToCharacter(characterID, "OnMailUndeleted", [messageIDs], options);
}

function sendLabelsCreatedNotification(characterID, label, options: Record<string, any> = {}) {
...
function sendMailingListRoleOperatorNotification(characterID, listID, options: Record<string, any> = {}) {
  sendNotificationToCharacter(characterID, "OnMailingListSetOperator", [Number(listID || 0) || 0], options);
}

function sendMailingListRoleMutedNotification(characterID, listID, options: Record<string, any> = {}) {
  sendNotificationToCharacter(characterID, "OnMailingListSetMuted", [Number(listID || 0) || 0], options);
}

function sendMailingListRoleClearNotification(characterID, listID, options: Record<string, any> = {}) {
  sendNotificationToCharacter(characterID, "OnMailingListSetClear", [Number(listID || 0) || 0], options);
}

function sendMailingListLeaveNotification(characterID, listID, affectedCharacterID, options: Record<string, any> = {}) {
  sendNotificationToCharacter(
    characterID,
    "OnMailingListLeave",
...
function sendMailingListDeletedNotification(characterID, listID, options: Record<string, any> = {}) {
