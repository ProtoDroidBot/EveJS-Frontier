...
function syncRemovedInventoryChanges(session, changes: any[] = []) {
...
function firstPresentValue(record, keys: any[] = []) {
...
class PosMgrService extends BaseService {
  declare controlTowerProvider: any;
  declare controlTowerRows: any;
