...
const { buildAccessibleStructureServices, characterHasStructureService, characterHasStructureSetting, } = require(path.join(__dirname, "./structurePayloads"));
const { STRUCTURE_SETTING_ID, getStructureSettingAccessErrorLabel, getStructureServiceAccessSettingID, } = require(path.join(__dirname, "./structureServiceAuthority"));
...
class StructureSettingsService extends BaseService {
    ...
    Handle_CharacterGetServices(args, session) {
        ...
        return buildDict(Object.entries(services)
...
//# sourceMappingURL=structureSettingsService.js.map