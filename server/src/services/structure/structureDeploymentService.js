...
const { cancelStructureUnanchorByID, deployStructureFromInventoryItem, normalizeExtraConfig, renameStructureByID, resolvePositionFromClientRequest, unanchorStructureByID, } = require(path.join(__dirname, "../sovereignty/sovPlayerDeployment"));
class StructureDeploymentService extends BaseService {
    ...
    Handle_Anchor(args, session) {
        ...
        const resolvedPosition = resolvePositionFromClientRequest(session, x, z);
...
//# sourceMappingURL=structureDeploymentService.js.map