...
function buildFallbackGeometry(structure, options: Record<string, any> = {}) {
...
function buildStructureDockingGeometry(structure, options: Record<string, any> = {}) {
...
function getStructureSpaceDirection(structure, options: Record<string, any> = {}) {
...
function getStructureDockPosition(structure, options: Record<string, any> = {}) {
  return buildStructureDockingGeometry(structure, {
    ...options,
...
function buildStructureUndockSpawnState(structure, options: Record<string, any> = {}) {
