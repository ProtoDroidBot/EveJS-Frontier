...
function buildAutoMoonFuelState(profile, nextCycleAt, extra: Record<string, any> = {}) {
  return {
...
function buildOfflineAutoMoonFuelPatch(structure, profile, nowMs, extra: Record<string, any> = {}) {
...
function offlineAutoMoonService(structure, profile, nowMs, extra: Record<string, any> = {}) {
