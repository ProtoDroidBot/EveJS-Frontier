...
function getBaseStructureHitpoints(structure: Record<string, any> = {}) {
...
function resolveStructureFullPowerDogma(structure: Record<string, any> = {}, options: Record<string, any> = {}) {
...
function resolveStructureEffectiveHitpoints(structure: Record<string, any> = {}, options: Record<string, any> = {}) {
