...
function normalizeVector(vector, fallback: { x: number; y: number; z: number } = DEFAULT_RIGHT) {
...
function buildStructureScatterPosition(structure, index = 0, options: Record<string, any> = {}) {
...
function buildStructureEmergencySpaceState(structure, index = 0, options: Record<string, any> = {}) {
