...
function buildProfileSettingsPayload(profile) {
  const settingsBySettingID =
    profile && profile.settingsBySettingID && typeof profile.settingsBySettingID === "object"
      ...
      : {};
  return buildDict(
    Object.entries<any>(settingsBySettingID)
...
function getCorporationProfileIDs(corporationID, extraProfileIDs: any[] = []) {
...
function notifyCorporationSessions(corporationID, notifyType, payload: any[] = []) {
