...
function syncStructureRuntime(systemID, options: Record<string, any> = {}) {
...
function spawnStructureDeathTestField(session, options: Record<string, any> = {}) {
