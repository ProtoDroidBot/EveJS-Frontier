...
function buildStructureLootContainerName(structure, options: Record<string, any> = {}) {
...
function createStructureLootContainer(structure, index, options: Record<string, any> = {}) {
...
function handleStructureDestroyedLoot(structure, options: Record<string, any> = {}) {
