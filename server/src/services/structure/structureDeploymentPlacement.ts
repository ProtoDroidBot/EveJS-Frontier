...
function buildSceneBalls(scene, options: Record<string, any> = {}) {
...
function resolveDeploymentBalls(solarSystemID, options: Record<string, any> = {}) {
...
function validateDeploymentPlacement({ solarSystemID, typeID, position, offset, scene }: Record<string, any>) {
