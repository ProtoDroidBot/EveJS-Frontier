...
class DynamicResourceCacheMgrService extends BaseService {
    ...
    Handle_GetESSSystemDetails(args) {
        ...
        log.debug(`[DynamicResourceCacheMgr] GetESSSystemDetails solarsystemid=${solarSystemID}`);
    ...
    Handle_GetESSReserveBankKeys(args, session) {
        ...
        log.debug(`[DynamicResourceCacheMgr] GetESSReserveBankKeys solarsystemid=${solarSystemID}`);
...
//# sourceMappingURL=dynamicResourceCacheMgrService.js.map