...
function cloneVector(vector: Record<string, any> = {}) {
  return {
...
function vectorDistance(left: Record<string, any> = {}, right: Record<string, any> = {}) {
...
function buildConduitPassengerPlans(options: Record<string, any> = {}) {
  const {
    fleet = null,
    anchorSession = null,
    anchorEntity = null,
...
function executeConduitPassengerJumps(options: Record<string, any> = {}) {
  const {
    plans = [],
    anchorCharacterID = 0,
    destinationSolarSystemID = 0,
