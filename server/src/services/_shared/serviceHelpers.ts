...
function buildKeyVal(entries: any[] = []) {
  return {
    type: "object",
    name: "util.KeyVal",
...
function buildNamedObject(name, entries: any[] = []) {
  return {
    type: "object",
    name,
    args: buildDict(entries),
...
function buildObjectEx1(name, args: any[] = [], stateEntries = null) {
  const header: any[] = [
...
function buildObjectEx2(name, stateEntries: any[] = []) {
  return {
    type: "objectex2",
    header: [
      [{ type: "token", value: String(name || "") }],
...
function buildRow(header: any[] = [], line: any[] = []) {
  return {
    type: "object",
    name: "util.Row",
    args: buildDict([
...
function buildRowset(header: any[] = [], rows: any[] = [], name = "util.Rowset") {
  return {
    type: "object",
    name,
    args: buildDict([
...
function buildPackedRowDescriptor(columns: any[] = [], virtualColumns: any[] = []) {
  const header: any[] = [
...
function buildPackedRow(columns: any[] = [], fields: Record<string, any> = {}, virtualColumns: any[] = []) {
  return {
    type: "packedrow",
...
function buildPackedRowFromRowsetLine(columns: any[] = [], descriptor, line) {
...
function findRowsetColumnIndex(columns: any[] = [], keyColumn = null) {
  if (!keyColumn) {
    return -1;
  }
...
function getIndexedRowKey(entry, row, columns: any[] = [], keyColumn = null) {
...
function buildPythonSet(values: any[] = []) {
...
function buildMarshalRealVectorList(value, fallback: number[] | { x: number; y: number; z: number } = [0, 0, 0]) {
...
function mapMarshalEntriesToObject(entries: any[] = [], depth = 0) {
