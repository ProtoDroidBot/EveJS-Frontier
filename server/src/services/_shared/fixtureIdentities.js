...
const { peekCharacterRecord, } = require(path.join(__dirname, "..", "character", "characterState"));
const { NPC_STARTER_CORPORATION_ID, getAllianceRecord, getCorporationRecord, } = require(path.join(__dirname, "..", "corporation", "corporationState"));
const seeder = require(path.join(__dirname, "..", "corporation", "coreFixtureSeeder"));
...
function resolveAllianceIdentity(role, allianceID) {
    ...
    return {
        ...
        executorCorporationID: toPositiveInteger(record.executorCorporationID || record.executorCorpID) ||
            null,
    };
}
/**
...
//# sourceMappingURL=fixtureIdentities.js.map