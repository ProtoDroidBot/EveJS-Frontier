...
function buildGodmaShipEffectEvent(itemID, ownerID, shipID, effectID, time, options = {}) {
    ...
    const repeat = typeof options.repeat === "number"
...
function buildOnMultiEventPayload(subEvents, time) {
    return buildOnMultiEventPayloadFromPairs((Array.isArray(subEvents) ? subEvents : [])
        .filter(Boolean)
...
//# sourceMappingURL=godmaMultiEvent.js.map