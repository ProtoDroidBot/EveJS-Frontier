...
function calculateChargeCapacity({ moduleCapacity, chargeVolume } = {}) {
    ...
    const missingFacts = [];
    if (capacity === null)
        missingFacts.push("module-capacity-missing-or-nonpositive");
    if (volume === null)
        missingFacts.push("charge-volume-missing-or-nonpositive");
    return {
 ...
 */
function evaluateChargeCompatibility({ declaredChargeGroupIDs, chargeGroupID, moduleChargeSize, chargeSize, moduleCapacity, chargeVolume, } = {}) {
    ...
    if (normalizedChargeGroupID === null ||
    ...
    if (capacity.maximumQuantity <= 0) {
        return {
            ...
            groupConstraint: "matched",
            sizeConstraint: normalizedModuleSize !== null && normalizedChargeSize !== null
                ? "matched"
    ...
    return {
        ...
        sizeConstraint: normalizedModuleSize !== null && normalizedChargeSize !== null
            ? "matched"
            : "not-declared-on-both-sides",
        capacityConstraint: capacity.status === "authoritative"
            ? "fits"
...
//# sourceMappingURL=chargeCompatibilityPolicy.js.map