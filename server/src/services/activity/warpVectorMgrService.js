...
const WARP_VECTOR_UNAVAILABLE_NOTIFY = "No verified warp vector destination is available.";
const auditEvents = [];
...
class WarpVectorMgrService extends BaseService {
    ...
    Handle_UseVector(args, session) {
        ...
        log.debug("[WarpVectorMgr] UseVector rejected: verified Operation Epiphany vector destinations are not available");
...
//# sourceMappingURL=warpVectorMgrService.js.map