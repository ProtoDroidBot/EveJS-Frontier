...
class VoidSpaceMgrService extends BaseService {
    ...
    Handle_VoidSpacePlayerJump(args, session) {
        ...
        log.debug("[VoidSpaceMgr] VoidSpacePlayerJump rejected: Void Space encounter runtime is not available");
    ...
    Handle_VoidSpaceEndGateActivation(args, session) {
        ...
        log.debug("[VoidSpaceMgr] VoidSpaceEndGateActivation rejected: no active Void Space origin state exists");
        throwGateRejected();
    }
...
//# sourceMappingURL=voidSpaceMgrService.js.map