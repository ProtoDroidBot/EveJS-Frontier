...
function recordAuditEvent(kind, args: any[] = [], session = null, details: Record<string, any> = {}) {
  auditEvents.push({
    kind,
    args: cloneArgs(args),
...
function normalizeNpc(entry: Record<string, any> = {}) {
  return {
...
function normalizeSpawn(entry: Record<string, any> = {}) {
...
function marshalNpc(entry: Record<string, any> = {}) {
  return buildDict([
...
function marshalSpawn(entry: Record<string, any> = {}) {
  return buildDict([
...
function marshalReport(report: Record<string, any> = {}) {
  return buildDict([
