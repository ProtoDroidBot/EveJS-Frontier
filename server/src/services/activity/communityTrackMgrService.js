...
function normalizeInstanceAttributes(attributes = null) {
    ...
    const definitionID = toInteger(attributes.definitionID ??
...
class CommunityTrackMgrService extends BaseService {
    ...
    Handle_get_instance_attributes_public(args, session) {
        ...
        const attributes = normalizeInstanceAttributes(instanceAttributesByID.get(instanceID));
        if (!attributes) {
...
//# sourceMappingURL=communityTrackMgrService.js.map