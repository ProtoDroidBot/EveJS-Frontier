...
class PvpFilamentMgrService extends BaseService {
    ...
    Handle_GetCharacterStatistics(args, session) {
        ...
        notify(session, "OnPVPFilamentsCharacterStatistics", buildCharacterStatisticsInfo(args));
        return null;
    }
    ...
    Handle_AbyssalPVPEndGateActivation(args, session) {
        ...
        log.debug("[PvpFilamentMgr] AbyssalPVPEndGateActivation rejected: no active Proving Grounds origin trace");
...
//# sourceMappingURL=pvpFilamentMgrService.js.map