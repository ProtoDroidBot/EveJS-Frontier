...
const { readRuntimeAccount, writeRuntimeAccount, } = require(path.join(__dirname, "../newEdenStore/storeState"));
...
class LoginCampaignMgrService extends BaseService {
    ...
    Handle_get_client_campaign_state(args, session) {
        ...
        const progress = normalizeProgress(readRuntimeAccount(accountIDFromSession(session)).dailyLoginCampaign);
...
//# sourceMappingURL=loginCampaignService.js.map