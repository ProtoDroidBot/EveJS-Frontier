...
function buildKillmailItemTreeFromInventoryItem(item, options: Record<string, any> = {}) {
  const quantityField =
...
function buildKillmailItemTreeForLocation(locationID, options: Record<string, any> = {}) {
