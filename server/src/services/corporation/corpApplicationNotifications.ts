...
function buildApplicationNotificationData(corporationID, characterID, extra: Record<string, any> = {}) {
  return {
...
function notifyCorporationApplicationRejected(
  ...
  const extra: Record<string, any> = { applicationText: normalizeText(applicationText, "") };
