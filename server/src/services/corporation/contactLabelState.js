...
function allocateNextLabelID(labels = {}, nextLabelIDHint = 1) {
    const usedIDs = new Set(Object.keys(labels || {}).map((labelID) => toNonNegativeBigInt(labelID, 0n).toString()));
...
function addLabelMask(currentMask, labelMask) {
    return toStoredMaskValue(toNonNegativeBigInt(currentMask, 0n) | toNonNegativeBigInt(labelMask, 0n));
}
...
//# sourceMappingURL=contactLabelState.js.map