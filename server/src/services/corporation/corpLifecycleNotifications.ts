...
function notifyCorporationMembers(corporationID, typeID, data, options: Record<string, any> = {}) {
...
function notifyCorporationNewCeo(corporationID, options: Record<string, any> = {}) {
  const numericCorporationID = normalizePositiveInteger(corporationID, null);
...
function notifyCorporationTaxRateChanged(corporationID, options: Record<string, any> = {}) {
  const numericCorporationID = normalizePositiveInteger(corporationID, null);
  if (!numericCorporationID) {
    return [];
  }
