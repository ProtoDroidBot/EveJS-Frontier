...
const { listCorporationMembers, normalizePositiveInteger, } = require(path.join(__dirname, "./corporationRuntimeState"));
const { CUSTOM_CORPORATION_ID_START, } = require(path.join(__dirname, "./corporationState"));
const { resolveApplicationRecipientIDs, } = require(path.join(__dirname, "./corpApplicationNotifications"));
...
function notifyCorporationNewCeo(corporationID, options = {}) {
    ...
    return notifyCorporationMembers(numericCorporationID, NOTIFICATION_TYPE.CORP_NEW_CEO, { corpID: numericCorporationID }, { excludeCharacterID: options.excludeCharacterID });
}
...
function notifyCorporationTaxRateChanged(corporationID, options = {}) {
    ...
    return notifyCorporationMembers(numericCorporationID, NOTIFICATION_TYPE.CORP_TAX_CHANGE, { corpID: numericCorporationID }, { excludeCharacterID: options.excludeCharacterID });
}
...
//# sourceMappingURL=corpLifecycleNotifications.js.map