...
const { buildDict, buildKeyVal, buildPythonSet, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
const { getLockedItemLocations, getLockedItemsByLocation, } = require(path.join(__dirname, "./corporationRuntimeState"));
class ItemLockingService extends BaseService {
    ...
    Handle_GetItemsByLocation(args, session) {
        ...
        return buildDict(getLockedItemsByLocation(corporationID, locationID).map((item) => [
...
//# sourceMappingURL=itemLockingService.js.map