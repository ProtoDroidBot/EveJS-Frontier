...
const { buildFiletimeLong, buildList, currentFileTime, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
...
const { normalizePositiveInteger, updateCorporationRuntime, getCorporationRuntime, } = require(path.join(__dirname, "./corporationRuntimeState"));
...
class FwCharacterEnlistmentMgrService extends BaseService {
    ...
    Handle_GetMyEnlistment(args, session) {
        ...
        const directFactionID = normalizePositiveInteger(characterRecord.directFactionID, null) || null;
        const corpFactionID = normalizePositiveInteger(corporationRecord.factionID, null) || null;
        return [
...
//# sourceMappingURL=fwCharacterEnlistmentMgrService.js.map