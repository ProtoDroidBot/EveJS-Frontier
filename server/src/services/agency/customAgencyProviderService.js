...
const { buildDict, buildFiletimeLong, buildList, buildObjectEx1, normalizeNumber, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
...
function normalizeCustomContentRecord(rawRecord) {
    ...
    const sourceContentID = toInt(getFirstPresent(record, FIELD_ALIASES.source_content_id), agencyContentID);
...
function buildCustomContentDataPayload(rawRecord) {
    ...
    return buildObjectEx1(CUSTOM_CONTENT_DATA_CLASS, [
...
//# sourceMappingURL=customAgencyProviderService.js.map