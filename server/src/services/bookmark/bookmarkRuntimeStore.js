...
const { OWNER_SYSTEM, TYPE_SOLAR_SYSTEM, } = require(path.join(__dirname, "./bookmarkConstants"));
const { normalizeBookmarkText, } = require(path.join(__dirname, "./bookmarkPayloads"));
...
//# sourceMappingURL=bookmarkRuntimeStore.js.map