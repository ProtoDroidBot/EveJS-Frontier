...
function buildBookmarkPayload(record: Record<string, any> = {}) {
  return buildKeyVal([
...
function buildFolderPayload(record: Record<string, any> = {}, options: Record<string, any> = {}) {
...
function buildSubfolderPayload(record: Record<string, any> = {}) {
  return buildKeyVal([
...
function buildGroupPayload(record: Record<string, any> = {}) {
  return buildKeyVal([
...
function buildBookmarkIDSet(bookmarkIDs: any[] = []) {
  return buildList(
...
function buildBookmarkDict(bookmarks: any[] = []) {
  return buildDict(
 ...
 */
function buildBookmarkReplyTuple(record: Record<string, any> = {}) {
  return [
...
function isCoordinateBookmark(record: Record<string, any> = {}) {
  return Boolean(
