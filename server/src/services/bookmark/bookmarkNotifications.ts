...
function collectRecipientSessions(folderIDs: any[] = [], excludeCharacterID = 0) {
...
function notifyBookmarksAdded(folderID, bookmarks, options: Record<string, any> = {}) {
...
function notifyBookmarksUpdated(folderID, bookmarks, options: Record<string, any> = {}) {
  if (!Array.isArray(bookmarks) || bookmarks.length <= 0) {
    return;
  }
  sendFolderUpdated(
...
function notifyBookmarksRemoved(folderID, bookmarkIDs, options: Record<string, any> = {}) {
...
function notifyBookmarksMoved(oldFolderID, newFolderID, bookmarks, options: Record<string, any> = {}) {
  if (!Array.isArray(bookmarks) || bookmarks.length <= 0) {
    return;
  }
  sendFolderUpdated(
...
function notifyFolderUpdated(folderID, folder, options: Record<string, any> = {}) {
  sendFolderUpdated(
    [folderID],
...
function notifySubfolderAdded(folderID, subfolder, options: Record<string, any> = {}) {
  sendFolderUpdated(
    [folderID],
...
function notifySubfolderUpdated(folderID, subfolderID, subfolderName, options: Record<string, any> = {}) {
  sendFolderUpdated(
    [folderID],
...
function notifySubfolderRemoved(folderID, subfolderID, options: Record<string, any> = {}) {
  sendFolderUpdated(
    [folderID],
...
function notifyFolderDeleted(folderID, options: Record<string, any> = {}) {
