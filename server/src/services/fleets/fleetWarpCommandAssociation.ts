...
function buildParticipantMarker(options: Record<string, any> = {}) {
...
function buildFleetWarpCommandAssociationPlan(options: Record<string, any> = {}) {
...
function getFleetWarpCommandAssociation(entity, options: Record<string, any> = {}) {
