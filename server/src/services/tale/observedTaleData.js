...
const { buildDict, buildKeyVal, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
...
function getObservedTaleIDsForSolarSystem(solarSystemID) {
    ...
    return (OBSERVED_TALE_IDS_BY_SOLAR_SYSTEM_ID[normalizedSolarSystemID] || []).slice();
}
...
function buildObservedTalesDict(solarSystemID, taleIDs = null) {
    ...
    return buildDict(normalizeTaleIDs(taleIDs, normalizedSolarSystemID).map((taleID) => [
        taleID,
...
//# sourceMappingURL=observedTaleData.js.map