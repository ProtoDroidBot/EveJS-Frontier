...
function sendTaleData(session, solarSystemID = null, talesByID = null) {
    if (!session || typeof session.sendNotification !== "function") {
        return false;
    }
    const targetSystemID = normalizePositiveInteger(solarSystemID, 0) ||
...
//# sourceMappingURL=taleMgrService.js.map