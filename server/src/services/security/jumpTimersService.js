...
const { buildClientJumpTimerTuple, } = require(path.join(__dirname, "../_shared/jumpTimerRuntime"));
class JumpTimersService extends BaseService {
    ...
    Handle_GetTimers(args, session) {
        ...
        const characterID = requestedCharacterID > 0 && requestedCharacterID === sessionCharacterID
...
//# sourceMappingURL=jumpTimersService.js.map