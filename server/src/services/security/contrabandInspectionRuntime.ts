...
function getInspectionRoll(options: Record<string, any> = {}) {
...
function applyContrabandPenalties(characterID, authority, entries, options: Record<string, any> = {}) {
...
function inspectCharacterContraband(characterID, shipID, solarSystemID, options: Record<string, any> = {}) {
