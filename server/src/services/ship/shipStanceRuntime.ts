...
function getStanceIDForModeType(shipTypeID, modeTypeID) {
  ...
  for (const [stanceID, mappedModeTypeID] of Object.entries<any>(mapping)) {
...
function buildShipStanceSlimTuple(shipOrID, options: Record<string, any> = {}) {
...
function setShipStance(shipID, stanceID, session, options: Record<string, any> = {}) {
