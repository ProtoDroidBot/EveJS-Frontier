...
function getRuntimeConfig(options: Record<string, any> = {}) {
...
function isSafeLogoffEnabled(options: Record<string, any> = {}) {
...
function resolveActiveSpaceShipID(session, options: Record<string, any> = {}) {
...
function markSafeLogoffCompletion(session, values: Record<string, any> = {}) {
  if (!session || typeof session !== "object") {
    return null;
  }
...
function consumeSafeLogoffCompletion(session, expected: Record<string, any> = {}) {
...
function resolveSpaceContext(session, options: Record<string, any> = {}) {
...
function getCrimewatchState(characterID, nowMs, options: Record<string, any> = {}) {
...
function isCharacterInFleet(session, characterID, options: Record<string, any> = {}) {
...
function isCharacterInvulnerable(characterID, options: Record<string, any> = {}) {
...
function evaluateSafeLogoffConditions(session, options: Record<string, any> = {}) {
...
function notifySession(session, eventName, args: any[] = []) {
...
function cancelSafeLogoff(session, options: Record<string, any> = {}) {
...
function beginSafeLogoff(session, options: Record<string, any> = {}) {
  if (!session || !resolveCharacterID(session)) {
    return { success: false as const, errorMsg: "SESSION_REQUIRED" };
  }
  if (!isSafeLogoffEnabled(options)) {
    return { success: false as const, errorMsg: "SAFE_LOGOFF_DISABLED" };
  }
