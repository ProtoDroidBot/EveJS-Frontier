...
function normalizeEntry(shipID, backendSlot, value: Record<string, any> = {}) {
...
function buildIndex() {
  ...
  for (const [shipID, rawShipEntry] of Object.entries<any>(root.ships || {})) {
    ...
    for (const [backendSlot, rawEntry] of Object.entries<any>(rawSlots)) {
...
function setDisplayedLogo(shipID, backendSlot, cosmeticType, options: Record<string, any> = {}) {
