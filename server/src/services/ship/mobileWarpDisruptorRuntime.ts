...
function launchMobileWarpDisruptorFromShip(session, itemID, options: Record<string, any> = {}) {
...
function collectActiveWarpDisruptors(systemID, options: Record<string, any> = {}) {
...
function findActiveWarpDisruptorForPosition(systemID, position, options: Record<string, any> = {}) {
...
function findActiveWarpDisruptorForEntity(systemID, entity, options: Record<string, any> = {}) {
...
function isPositionWarpDisrupted(systemID, position, options: Record<string, any> = {}) {
