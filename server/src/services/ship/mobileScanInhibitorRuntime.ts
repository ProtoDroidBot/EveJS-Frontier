...
function launchMobileScanInhibitorFromShip(session, itemID, options: Record<string, any> = {}) {
...
function collectActiveScanInhibitors(systemID, options: Record<string, any> = {}) {
...
function findActiveScanInhibitorForPosition(systemID, position, options: Record<string, any> = {}) {
...
function isPositionScanInhibited(systemID, position, options: Record<string, any> = {}) {
