...
function isActiveWarpDisruptSphereEffect(effectState, options: Record<string, any> = {}) {
...
function listActiveWarpDisruptSphereEffects(entity, options: Record<string, any> = {}) {
  if (
    !entity ||
...
function buildActiveWarpDisruptorCandidate(entity, options: Record<string, any> = {}) {
