...
function writeShipDirtRecord(record) {
    ...
    const writeResult = database.write(SHIP_DIRT_TABLE, `/ships/${String(record.itemID)}`, record);
...
function clearShipDirtTimestamp(itemID, reason = "clear") {
    ...
    const removeResult = database.remove(SHIP_DIRT_TABLE, `/ships/${String(numericItemID)}`);
    return {
...
//# sourceMappingURL=shipDirtState.js.map