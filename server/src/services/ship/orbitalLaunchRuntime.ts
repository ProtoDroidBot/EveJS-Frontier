...
function launchOrbitalItem(session, itemID, options: Record<string, any> = {}) {
...
function launchSovereigntyStructureFromShip(session, itemID, options: Record<string, any> = {}) {
...
function launchOrbitalsFromShip(session, rawItemIDs, options: Record<string, any> = {}) {
