...
const { buildDict, buildList, extractList, normalizeNumber, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
...
class RewardMgrService extends BaseService {
    ...
    Handle_GetDelayedRewardsByGroupIDs(args, session) {
        ...
        log.debug(`[RewardMgr] GetDelayedRewardsByGroupIDs groups=${rewardGroupIDs.length} -> empty dict`);
        return buildDict([]);
    }
...
//# sourceMappingURL=rewardMgrService.js.map