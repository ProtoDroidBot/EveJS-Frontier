...
const { getSessionCharacterID, getSessionClientID, normalizeInteger, } = require(path.join(__dirname, "./raffleHelpers"));
class RaffleSubscriptions {
    ...
    getInterestedSessions(raffleState, options = {}) {
        ...
        for (const session of sessionRegistry.getSessions()) {
            ...
            if (this._ticketSubscribers.has(clientId) ||
...
//# sourceMappingURL=raffleSubscriptions.js.map