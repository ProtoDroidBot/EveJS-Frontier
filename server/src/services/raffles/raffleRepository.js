...
const { normalizeBigInt, } = require(path.join(__dirname, "../_shared/serviceHelpers"));
...
function encodeRaffleState(raffleState) {
    ...
    const encoded = {
        ...
        metaData: raffleState.metaData && typeof raffleState.metaData === "object"
            ? cloneValue(raffleState.metaData)
            : {},
        inventory: raffleState.inventory && typeof raffleState.inventory === "object"
            ? cloneValue(raffleState.inventory)
            : {},
        settlement: raffleState.settlement && typeof raffleState.settlement === "object"
...
//# sourceMappingURL=raffleRepository.js.map