...
function mapEntriesToObject(entries: any[] = [], depth = 0) {
...
function dedupeTicketNumbers(values: any[] = []) {
...
function pickSeedPolarisItem(items, preferredTypeIds: any[] = []) {
...
function shuffleArray(values: any[] = []) {
...
function pickRandomEntries(values: any[] = [], count = 0) {
...
function matchesGrabFilters(raffleState, filters: Record<string, any> = {}, constraints: Record<string, any> = {}, viewerCharacterId = 0) {
...
function groupTicketsByOwner(tickets: any[] = []) {
...
function pickWinningTicket(tickets: any[] = []) {
