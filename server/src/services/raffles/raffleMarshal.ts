...
function buildMetaDataValue(metaData: Record<string, any> = {}) {
  return {
    type: "dict",
...
function buildCharacterStatisticsValue(stats: Record<string, any> = {}) {
  return buildKeyVal([
...
function buildTypeStatisticsValue(stats: Record<string, any> = {}) {
  return {
    type: "dict",
    entries: [
