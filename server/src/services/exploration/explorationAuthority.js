...
function normalizePayload(payload = {}) {
    return {
        ...
        scanContracts: payload && typeof payload.scanContracts === "object" ? payload.scanContracts : {},
        ...
        probeLauncherChargeCompatibility: payload && typeof payload.probeLauncherChargeCompatibility === "object"
            ? payload.probeLauncherChargeCompatibility
            : {},
        probeLauncherDogmaProfilesByTypeID: payload && typeof payload.probeLauncherDogmaProfilesByTypeID === "object"
            ? payload.probeLauncherDogmaProfilesByTypeID
            : {},
        probeFormations: payload && typeof payload.probeFormations === "object" ? payload.probeFormations : {},
        probeScanGroups: payload && typeof payload.probeScanGroups === "object" ? payload.probeScanGroups : {},
        scanStrengthAttributes: payload && typeof payload.scanStrengthAttributes === "object"
            ? payload.scanStrengthAttributes
            : {},
        signatureTypeDefinitions: payload && typeof payload.signatureTypeDefinitions === "object"
            ? payload.signatureTypeDefinitions
            : {},
        wormholeAuthority: payload && typeof payload.wormholeAuthority === "object" ? payload.wormholeAuthority : {},
...
//# sourceMappingURL=explorationAuthority.js.map