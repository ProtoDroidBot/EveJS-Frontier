...
function normalizePayload(payload = {}) {
    return {
        ...
        systemsByClass: payload.systemsByClass && typeof payload.systemsByClass === "object"
...
function buildCache() {
    ...
    for (const system of payload.systems) {
        const normalizedSystem = {
            ...
            environmentPosition: system.environmentPosition && typeof system.environmentPosition === "object"
                ? {
    ...
    for (const [classKey, systemIDs] of Object.entries(payload.systemsByClass || {})) {
        candidateSystemIDsByClass.set(toInt(classKey, 0), (Array.isArray(systemIDs) ? systemIDs : [])
...
function getCodeTypeRecord(codeOrTypeID) {
    ...
    return ensureCache().codeTypesByCode.get(String(codeOrTypeID || "").trim().toUpperCase()) || null;
}
...
//# sourceMappingURL=wormholeAuthority.js.map