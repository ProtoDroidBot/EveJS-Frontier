...
function encodeSignatureCodeFromNumber(rawValue) {
    ...
    for (let index = 0; index < 3; index += 1) {
        letters.unshift(SIGNATURE_CODE_LETTERS[remainingLetterValue % SIGNATURE_CODE_LETTERS.length]);
        remainingLetterValue = Math.floor(remainingLetterValue / SIGNATURE_CODE_LETTERS.length);
    }
...
//# sourceMappingURL=targetIdRuntime.js.map