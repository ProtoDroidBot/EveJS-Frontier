...
function listSystemSignatureSites(systemID, options: Record<string, any> = {}) {
...
function listSystemAnomalySites(systemID, options: Record<string, any> = {}) {
  return normalizeSiteCollection(
...
function listSystemStaticSites(systemID, options: Record<string, any> = {}) {
  return normalizeSiteCollection(
...
function listSystemStructureSites(systemID, options: Record<string, any> = {}) {
...
function buildSystemSignatureViews(systemID, options: Record<string, any> = {}) {
...
function buildSystemScannableViews(systemID, options: Record<string, any> = {}) {
...
function buildSignalTrackerFullState(systemID, options: Record<string, any> = {}) {
...
function buildSignalTrackerSignatureEntries(systemID, options: Record<string, any> = {}) {
  return listSystemSignatureSites(systemID, options).map((site) => [
    site.siteID,
...
function buildSignalTrackerAnomalyEntries(systemID, options: Record<string, any> = {}) {
...
function buildSignalTrackerStaticSiteEntries(systemID, options: Record<string, any> = {}) {
...
function buildSignalTrackerStructureEntries(systemID, options: Record<string, any> = {}) {
...
function listAllScannableSites(systemID, options: Record<string, any> = {}) {
  return [
...
function getScanTargetID(systemID, siteID, options: Record<string, any> = {}) {
...
function resolveSiteByTargetID(systemID, targetID, options: Record<string, any> = {}) {
...
function listWormholeSignatureSites(systemID, options: Record<string, any> = {}) {
  return normalizeSiteCollection(
