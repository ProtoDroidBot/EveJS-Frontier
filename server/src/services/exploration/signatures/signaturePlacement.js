...
function buildAnchorRelativeSignaturePlacement(anchorCandidates = [], seed, options = {}) {
    ...
    const verticalJitterAu = Math.max(0, toFiniteNumber(options.verticalJitterAu, DEFAULT_SIGNATURE_VERTICAL_JITTER_AU));
...
//# sourceMappingURL=signaturePlacement.js.map