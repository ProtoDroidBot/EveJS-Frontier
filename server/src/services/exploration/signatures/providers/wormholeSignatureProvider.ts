...
function isEndpointSignatureVisible(endpoint: Record<string, any> = {}) {
...
function listWormholeSignatureCandidates(systemID, options: Record<string, any> = {}) {
  ...
  return Object.values<any>(snapshot.pairsByID || {})
    .filter(
      (pair) =>
...
function allocateStableSignatureCodes(systemID, candidates: any[] = []) {
...
function listSignatureSites(systemID, options: Record<string, any> = {}) {
