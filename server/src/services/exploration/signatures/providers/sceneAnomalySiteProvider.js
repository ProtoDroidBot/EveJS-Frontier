...
function listAnomalySites(systemID, options = {}) {
    ...
    return collectSceneEntities(scene)
        ...
        const family = String(entity && (entity.signalTrackerSiteFamily ||
            entity.signalTrackerAnomalySiteFamily) || "unknown").trim().toLowerCase() || "unknown";
        ...
        const enrichedSite = dungeonSiteAdapter.enrichSiteWithDungeonRuntime({
            ...
            label: String(entity && (entity.signalTrackerSiteLabel ||
                entity.itemName ||
                entity.slimName) || `Anomaly Site ${siteID}`).trim(),
            ...
            scanStrengthAttribute: toInt(entity && entity.signalTrackerStrengthAttributeID, explorationAuthority.getScanStrengthAttribute(family)) || null,
            allowedTypes: Array.isArray(entity && entity.signalTrackerAllowedTypes)
                ? [...entity.signalTrackerAllowedTypes]
                : [],
            entryObjectTypeID: toInt(entity && (entity.signalTrackerEntryObjectTypeID ??
...
//# sourceMappingURL=sceneAnomalySiteProvider.js.map