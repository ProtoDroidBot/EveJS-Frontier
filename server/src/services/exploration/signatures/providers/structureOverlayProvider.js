...
function listStructureSites(systemID, options = {}) {
    ...
    return structureState.listStructuresForSystem(numericSystemID, {
        ...
        return {
            ...
            siteKind: "structure",
            family: "structure",
            targetID: targetIdRuntime.encodeTargetID("structure", numericSystemID, toInt(structure && structure.structureID, 0)),
            label: String(structure && (structure.name || structure.itemName) ||
...
//# sourceMappingURL=structureOverlayProvider.js.map