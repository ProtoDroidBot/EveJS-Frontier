...
function issueCapitalAttackOrder(entityID, targetID, options: Record<string, any> = {}) {
...
function selectEarliestSummary(summaries: any[] = []) {
  return [...summaries]
...
function summarizeWingTypes(wingEntries: any[] = []) {
...
function formatSuggestions(suggestions: any[] = []) {
  return suggestions.length > 0
    ? ` Suggestions: ${suggestions.join(", ")}.`
    : "";
}

function buildSelectionErrorMessage(query, errorMsg, suggestions: any[] = []) {
