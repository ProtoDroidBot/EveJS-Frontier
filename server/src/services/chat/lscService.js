...
const { flushPendingCommandSessionEffects } = require(path.join(__dirname, "./commandSessionEffects"));
...
class LSCService extends BaseService {
    ...
    async Handle_SendMessage(args, session) {
        const rawMessage = args && args.length > 1 ? args[1] : args && args.length > 0 ? args[0] : "";
...
//# sourceMappingURL=lscService.js.map