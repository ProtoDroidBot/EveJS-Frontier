...
const { resolveSolarSystemByName, } = require(path.join(__dirname, "../solarSystemRegistry"));
const wormholeRuntime = require(path.join(__dirname, "../../exploration/wormholes/wormholeRuntime"));
    ...
    for (const entry of entries) {
        ...
        for (const touchpoint of touchpoints) {
            ...
            const existing = summariesBySystemID.get(systemID) || {
                ...
                environmentFamily: (wormholeRuntime.buildSystemSummaryViews({
                    systemID,
                    includeCollapsed: false,
                    includeUndiscovered: true,
                })[0] || {}).environmentFamily || null,
                environmentEffectTypeName: (wormholeRuntime.buildSystemSummaryViews({
                    systemID,
                    includeCollapsed: false,
                    includeUndiscovered: true,
...
//# sourceMappingURL=wormholeCommandHandlers.js.map