...
function buildDrifterDefinition(variant, index, options: Record<string, any> = {}) {
  const suffix = index + 1;
...
function spawnDefinitionPackForSession(session, definitions, options: Record<string, any> = {}) {
