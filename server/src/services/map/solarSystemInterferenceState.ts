...
function normalizeInterferenceState(rawState: Record<string, any> = {}) {
...
function normalizeStorageState(rawState: Record<string, any> = {}) {
...
function getInterferenceBand(rawState: Record<string, any> = {}) {
  const state = normalizeInterferenceState(rawState);
  if (state.interferenceLevel <= state.quiescentInterferenceLevel) {
