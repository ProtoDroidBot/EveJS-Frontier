...
function normalizeLicenseRecord(typeID, value: Record<string, any> = {}) {
...
function normalizeOfferRecord(offerID, value: Record<string, any> = {}) {
...
function buildIndexes() {
  ...
  for (const [typeID, rawLicense] of Object.entries<any>(root.licensesByTypeID || {})) {
  ...
  for (const [offerID, rawOffer] of Object.entries<any>(root.offersByOfferID || {})) {
  ...
  for (const [typeID, offerID] of Object.entries<any>(root.offerIDsByTypeID || {})) {
