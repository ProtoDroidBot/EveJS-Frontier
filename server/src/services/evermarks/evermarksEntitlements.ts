...
function normalizeEntitlementRecord(value: Record<string, any> = {}) {
...
function buildIndexes() {
  ...
  for (const [characterID, rawCharacter] of Object.entries<any>(root.characters || {})) {
    ...
    const rawEntitlements =
      rawCharacter && rawCharacter.shipLogosByKey && typeof rawCharacter.shipLogosByKey === "object"
        ...
        : {};
    const normalized = Object.values<any>(rawEntitlements)
...
function grantShipLogoEntitlement(characterID, shipTypeID, entitlementType, options: Record<string, any> = {}) {
...
function grantShipLogoEntitlementByTypeID(characterID, typeID, options: Record<string, any> = {}) {
