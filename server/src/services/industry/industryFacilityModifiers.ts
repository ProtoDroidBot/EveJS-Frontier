...
function cloneActivities(activities: Record<string, any> = {}) {
...
function applyFittedRigModifiers(structure, activities) {
  ...
  const rigModifiers: Record<string, any> = {};
...
function buildStructureIndustryFacilityModifiers(structure, activities: Record<string, any> = {}) {
