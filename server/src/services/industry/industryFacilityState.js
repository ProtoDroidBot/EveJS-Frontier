...
const { normalizeRoleValue, hasCorporationIndustryJobAccess, isCorporationOwner, } = require(path.join(__dirname, "./industryAccess"));
const { DEFAULT_TAX_RATE, INDUSTRY_FACILITY_STATE_TABLE, ITEM_FLAG_CORP_DELIVERIES, ROLE_FACTORY_MANAGER, } = require(path.join(__dirname, "./industryConstants"));
...
//# sourceMappingURL=industryFacilityState.js.map