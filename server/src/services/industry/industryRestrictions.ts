...
function resolveIndustrySlotUsage(activityID, jobCounts: Record<string, any> = {}) {
  const numericCounts =
...
function resolveIndustrySlotContext(activityID, characterID, jobCounts: Record<string, any> = {}) {
