...
const { getBlueprintDefinitionByProductTypeID, getBlueprintDefinitionByTypeID, } = require(path.join(__dirname, "./industryStaticData"));
...
//# sourceMappingURL=industryPricing.js.map