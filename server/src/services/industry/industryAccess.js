...
const { CORP_BLUEPRINT_VIEW_MASK, CORP_HANGAR_FLAGS, CORP_HANGAR_QUERY_ROLE_BY_FLAG, CORP_HANGAR_TAKE_ROLE_BY_FLAG, CORP_WALLET_TAKE_ROLE_BY_KEY, ITEM_FLAG_CORP_DELIVERIES, ROLE_FACTORY_MANAGER, } = require(path.join(__dirname, "./industryConstants"));
...
//# sourceMappingURL=industryAccess.js.map