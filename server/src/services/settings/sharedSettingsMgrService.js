...
class SharedSettingsMgrService extends BaseService {
    ...
    _storePayloadString(settingTypeID, payloadString, options = {}) {
        ...
        const existingEntry = this._findExistingEntry(normalizedSettingTypeID, hashvalue, normalizedPayloadString);
        if (existingEntry) {
        ...
        this._persistState();
        log.info(`[SharedSettingsMgr] Stored shared setting type=${normalizedSettingTypeID} hash=${hashvalue} sqID=${sqID}`);
        return entry;
    }
...
//# sourceMappingURL=sharedSettingsMgrService.js.map