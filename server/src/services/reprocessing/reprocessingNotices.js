...
const { buildReprocessingGatewayProtoRoot, } = require("./reprocessingGatewayProto");
const PROTO_ROOT = buildReprocessingGatewayProtoRoot();
const ReprocessedNotice = PROTO_ROOT.lookupType("eve.industry.reprocess.api.Reprocessed");
...
function publishReprocessedNotice(event = {}, options = {}) {
    ...
    publisher("eve.industry.reprocess.api.Reprocessed", encodePayload(ReprocessedNotice, buildReprocessedPayload(event)), {
...
//# sourceMappingURL=reprocessingNotices.js.map