...
const { toMarshalValue, } = require(path.join(__dirname, "./storeMarshal"));
...
function buildKiringConfiguration() {
    const redirectBaseUrl = typeof config.microservicesRedirectUrl === "string" &&
...
KiringMgrService._testing = {
    ...
    setSafeStateConfig(overrides = {}) {
        if (Object.prototype.hasOwnProperty.call(overrides, "eveGuardServerAddress")) {
            safeStateConfig.eveGuardServerAddress = normalizeOptionalString(overrides.eveGuardServerAddress);
        }
        if (Object.prototype.hasOwnProperty.call(overrides, "monochromeStyleEnabled")) {
            safeStateConfig.monochromeStyleEnabled =
                overrides.monochromeStyleEnabled === true;
        }
        if (Object.prototype.hasOwnProperty.call(overrides, "shouldKickCheater")) {
            safeStateConfig.shouldKickCheater = overrides.shouldKickCheater === true;
        }
    },
};
module.exports = KiringMgrService;
//# sourceMappingURL=kiringMgrService.js.map