...
function getLocalizedName(value) {
  ...
  if (value && typeof value === "object") {
    ...
    return Object.values<any>(value).find((candidate) => typeof candidate === "string") || "";
  }
  return "";
}
...
function collectSearchableOwners(groupID, options: Record<string, any> = {}) {
...
function searchGroup(groupID, search, exactMode, options: Record<string, any> = {}) {
