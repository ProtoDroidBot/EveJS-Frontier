...
function gatherCandidateMap(explicitCandidates: any[] = []) {
...
function scoreTemplate(template, site, hints: Record<string, any> = {}) {
  let score = 0;
...
function resolveTemplateForSite(site, hints: Record<string, any> = {}) {
...
function enrichSiteWithDungeonRuntime(site, options: Record<string, any> = {}) {
