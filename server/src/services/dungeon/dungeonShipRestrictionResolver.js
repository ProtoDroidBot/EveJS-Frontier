...
function resolveDungeonShipRestrictions(dungeonID, gateID = 0) {
    ...
    const connections = dungeon && Array.isArray(dungeon.connections) ? dungeon.connections : null;
    ...
    for (const connection of connections) {
        ...
        if (allowedShipsList > 0 || allowedRaces.size > 0) {
            ...
            const allowed = new Set(shipTypes
...
//# sourceMappingURL=dungeonShipRestrictionResolver.js.map