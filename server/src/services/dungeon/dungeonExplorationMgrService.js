...
function listRuntimeDungeonSitesForSystem(systemID) {
    ...
    return [
        ...
        .filter((site) => (Math.max(0, toInt(site && site.instanceID, 0)) > 0 &&
...
class DungeonExplorationMgrService extends BaseService {
    ...
    buildEscalatingPathDetails() {
        ...
        return buildRowset([...ESCALATING_PATH_HEADER], [], "eve.common.script.sys.rowset.Rowset");
    }
    ...
    buildInstancesForSolarSystem(systemID) {
        ...
        return buildDict(listRuntimeDungeonSitesForSystem(numericSystemID).map((site) => [
...
//# sourceMappingURL=dungeonExplorationMgrService.js.map