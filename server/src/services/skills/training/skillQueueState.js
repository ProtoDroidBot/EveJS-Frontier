...
const { buildFiletimeString, cloneValue, } = require("./skillTrainingMath");
...
function normalizeQueueState(rawState = {}) {
    ...
    return {
        ...
        activeStartTime: rawState.activeStartTime !== undefined && rawState.activeStartTime !== null
...
//# sourceMappingURL=skillQueueState.js.map