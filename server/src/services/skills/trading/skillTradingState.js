...
function normalizeTradingState(state = {}) {
    ...
    return {
        nextAlphaInjectionAt: normalizeBigInt(normalized.nextAlphaInjectionAt, 0n).toString(),
        nonDiminishingInjectionsRemaining: Math.max(0, toInt(normalized.nonDiminishingInjectionsRemaining, 0)),
...
function updateCharacterSkillTradingState(characterID, updater) {
    ...
    const nextValue = typeof updater === "function" ? updater(cloneValue(currentState)) : updater;
...
//# sourceMappingURL=skillTradingState.js.map