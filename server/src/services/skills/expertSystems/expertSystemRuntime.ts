...
function fail(errorMsg, message, options: Record<string, any> = {}) {
...
function validateExpertSystemInstall(characterID, expertSystemTypeID, options: Record<string, any> = {}) {
...
function installExpertSystemForCharacter(characterID, expertSystemTypeID, options: Record<string, any> = {}) {
...
function consumeExpertSystemItem(characterID, itemID, session = null, options: Record<string, any> = {}) {
  const numericCharacterID = toInt(characterID, 0);
...
function removeExpertSystemFromCharacter(characterID, expertSystemTypeID, options: Record<string, any> = {}) {
  const numericCharacterID = toInt(characterID, 0);
...
function clearExpertSystemsForCharacter(characterID, options: Record<string, any> = {}) {
  const numericCharacterID = toInt(characterID, 0);
  const previousSkillMap =
    options.emitNotifications === false
      ? null
  ...
  scheduleExpertSystemExpiry(numericCharacterID);
  return { success: true as const, data: clearResult.previousEntries || [] };
}

function getActiveExpertSystemsForCharacter(characterID, options: Record<string, any> = {}) {
...
function getExpertSystemStatus(characterID, options: Record<string, any> = {}) {
