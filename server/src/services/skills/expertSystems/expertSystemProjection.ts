...
function getActiveExpertSkillGrantMap(characterID, options: Record<string, any> = {}) {
...
function normalizeSkillRecords(skillRecords: any[] = []) {
  const map = new Map();
...
function buildProjectionCacheKey(characterID, skillRecords, options: Record<string, any> = {}) {
  return [
    toInt(characterID, 0),
...
function projectSkillRecordsForCharacter(characterID, skillRecords: any[] = [], options: Record<string, any> = {}) {
...
function buildProjectedSkillMap(skillRecords: any[] = []) {
  const map = new Map();
...
function diffProjectedSkillMaps(previousSkillMap, nextSkillMap) {
  const changedSkillRecords: any[] = [];
  const removedSkillRecords: any[] = [];
