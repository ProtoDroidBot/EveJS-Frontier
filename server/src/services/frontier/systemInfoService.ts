...
function buildSystemInfo(solarSystemID, options: Record<string, any> = {}) {
...
function resolveSystemID(args: any[] = [], session = null) {
...
function buildCrudeRiftInfo(solarSystemID, options: Record<string, any> = {}) {
