...
function listVisibleCairns(session, options: Record<string, any> = {}) {
...
class CairnService extends BaseService {
  ...
  constructor(serviceName = "cairnService", options: Record<string, any> = {}) {
    super(serviceName);
