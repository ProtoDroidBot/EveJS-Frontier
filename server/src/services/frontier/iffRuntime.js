...
function startBeacon({ beaconID, moduleTypeID, shipID, characterID, corporationID, solarSystemID, position, channel, code, durationMs, releaseImmobilizer, notifyMapChanged, nowMs = Date.now(), }) {
