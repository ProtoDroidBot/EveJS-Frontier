...
const { SOVEREIGNTY_TABLE, } = require(path.join(__dirname, "./sovConstants"));
...
function mergeSovereigntyTableDefaults(value = {}) {
    ...
    return {
        _meta: {
            version: Math.max(1, normalizeInteger(table && table._meta && table._meta.version, defaults._meta.version)),
            updatedAt: table && table._meta && table._meta.updatedAt
                ? String(table._meta.updatedAt)
                : null,
        },
        alliances: table && table.alliances && typeof table.alliances === "object"
            ? cloneValue(table.alliances)
            : {},
        systems: table && table.systems && typeof table.systems === "object"
            ? cloneValue(table.systems)
            : {},
        hubs: table && table.hubs && typeof table.hubs === "object"
            ? cloneValue(table.hubs)
            : {},
        skyhooks: table && table.skyhooks && typeof table.skyhooks === "object"
            ? cloneValue(table.skyhooks)
            : {},
        mercenaryDens: table && table.mercenaryDens && typeof table.mercenaryDens === "object"
        ...
        resources: {
            ...
            planetDefinitionsVersion: normalizeSemanticVersion(table && table.resources && table.resources.planetDefinitionsVersion),
            starConfigurations: table &&
                table.resources &&
...
//# sourceMappingURL=sovStore.js.map