...
function listSovereigntyFlexStructuresForSystem(solarSystemID, options: Record<string, any> = {}) {
...
function listFlexStructuresByKind(solarSystemID, kind, options: Record<string, any> = {}) {
...
function deploySovereigntyFlexStructure(session, kind, options: Record<string, any> = {}) {
