...
function normalizeEvolutionRecord(value: Record<string, any> = {}) {
...
function normalizeInfomorphsRecord(value: Record<string, any> = {}) {
...
function normalizeActivityTemplateDefinition(value: Record<string, any> = {}, fallback: Record<string, any> = {}) {
  return {
...
function normalizeMercenaryActivityRecord(value: Record<string, any> = {}, fallback: Record<string, any> = {}) {
  return {
...
function normalizeMercenaryDenRecord(value: Record<string, any> = {}) {
  const now = Date.now();
...
function applyMercenaryDenTimeTransitions(table) {
  ...
  for (const [mercenaryDenID, rawDen] of Object.entries<any>(table.mercenaryDens || {})) {
...
function buildCache(table) {
  ...
  for (const rawDen of Object.values<any>(table.mercenaryDens || {})) {
