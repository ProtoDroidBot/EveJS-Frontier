...
function isKnownSpaceSolarSystemID(solarSystemID) {
    ...
    return (numericSolarSystemID >= KNOWN_SPACE_SYSTEM_MIN &&
...
function isSovereigntyClaimableSolarSystem(solarSystemOrID) {
    ...
    const solarSystemID = normalizePositiveInteger(solarSystem && solarSystem.solarSystemID, normalizePositiveInteger(solarSystemOrID, null));
...
//# sourceMappingURL=sovSystemRules.js.map