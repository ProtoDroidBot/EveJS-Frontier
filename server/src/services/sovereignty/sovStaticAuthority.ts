...
function normalizeSemanticVersion(value: Record<string, any> = {}) {
...
function buildPlanetsBySolarSystemID(values) {
  ...
  for (const [solarSystemID, planetIDs] of Object.entries<any>(values)) {
...
function normalizeDefinitionRows(value) {
  ...
  if (value && typeof value === "object") {
    return cloneValue(Object.values<any>(value));
  }
  return [];
}
