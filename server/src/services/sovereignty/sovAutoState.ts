...
function getFlexShowcaseDefinitionsForJob(job, options: Record<string, any> = {}) {
...
function applyAutomationStep(job, actionLabel, fn, options: Record<string, any> = {}) {
...
function createJob(mode, solarSystemID, session, options: Record<string, any> = {}) {
...
function startClaim(session, solarSystemID, targetAllianceID, targetCorporationID, options: Record<string, any> = {}) {
...
function startTakeover(session, solarSystemID, targetAllianceID, targetCorporationID, options: Record<string, any> = {}) {
  const validation = ensureValidSolarSystem(solarSystemID);
  if (!validation.success) {
    return validation;
  }
...
function startLoss(session, solarSystemID, nextAllianceID = null, nextCorporationID = null, options: Record<string, any> = {}) {
  const validation = ensureValidSolarSystem(solarSystemID);
  if (!validation.success) {
    return validation;
  }
