...
const { getCharacterRecord, getActiveShipRecord, findCharacterShip, activateShipForSession, buildItemChangePayload, buildChargeSublocationItem, syncInventoryItemForSession, syncChargeGodmaPrimeForSession, syncShipFittingStateForSession, buildChargeDogmaPrimeEntry, syncDamageStateAttributesForSession, } = require(path.join(__dirname, "../character/characterState"));
