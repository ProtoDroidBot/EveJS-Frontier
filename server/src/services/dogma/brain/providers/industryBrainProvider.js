...
function getCharacterIndustrySkillLevels(characterID) {
    ...
    for (const skill of getCharacterSkills(toInt(characterID, 0))) {
        ...
        levels.set(typeID, clampIndustrySkillLevel(skill &&
        ...
        for (const effectID of typeEntry.effects) {
            ...
            for (const modifier of modifierInfo) {
                ...
                if (sourceAttributeID === 280) {
                    ...
                    const perLevelBase = toFiniteNumber(typeEntry.attributes[String(sourceAttributeID)] ??
                        typeEntry.attributes[sourceAttributeID], getAttributeDefaultValue(sourceAttributeID));
...
function resolveComputedIndustryAttributes(characterID) {
    ...
    return {
        [ATTRIBUTE_MANUFACTURE_SLOT_LIMIT]: INDUSTRY_BASE_SLOT_LIMIT +
        ...
        [ATTRIBUTE_MAX_LABORATORY_SLOTS]: INDUSTRY_BASE_SLOT_LIMIT +
        ...
        [ATTRIBUTE_REACTION_SLOT_LIMIT]: INDUSTRY_BASE_SLOT_LIMIT +
        ...
        [ATTRIBUTE_MANUFACTURE_TIME_MULTIPLIER]: roundIndustryAttributeValue(applyIndustryPercentPerLevel(applyIndustryPercentPerLevel(1, -4, industryLevel), -3, advancedIndustryLevel)),
        [ATTRIBUTE_MANUFACTURING_TIME_RESEARCH_SPEED]: roundIndustryAttributeValue(applyIndustryPercentPerLevel(applyIndustryPercentPerLevel(1, -5, researchLevel), -3, advancedIndustryLevel)),
        [ATTRIBUTE_COPY_SPEED_PERCENT]: roundIndustryAttributeValue(applyIndustryPercentPerLevel(applyIndustryPercentPerLevel(1, -5, scienceLevel), -3, advancedIndustryLevel)),
        [ATTRIBUTE_MINERAL_NEED_RESEARCH_SPEED]: roundIndustryAttributeValue(applyIndustryPercentPerLevel(applyIndustryPercentPerLevel(1, -5, metallurgyLevel), -3, advancedIndustryLevel)),
        [ATTRIBUTE_INVENTION_RESEARCH_SPEED]: roundIndustryAttributeValue(applyIndustryPercentPerLevel(1, -3, advancedIndustryLevel)),
        [ATTRIBUTE_REACTION_TIME_MULTIPLIER]: roundIndustryAttributeValue(applyIndustryPercentPerLevel(1, -4, reactionsLevel)),
    };
}
function resolveCharacterIndustryAttributes(characterID) {
    ...
    const attributes = {
        [ATTRIBUTE_MANUFACTURE_SLOT_LIMIT]: toFiniteNumber(source[ATTRIBUTE_MANUFACTURE_SLOT_LIMIT] ?? computed[ATTRIBUTE_MANUFACTURE_SLOT_LIMIT], computed[ATTRIBUTE_MANUFACTURE_SLOT_LIMIT]),
        [ATTRIBUTE_MANUFACTURE_TIME_MULTIPLIER]: toFiniteNumber(source[ATTRIBUTE_MANUFACTURE_TIME_MULTIPLIER] ?? computed[ATTRIBUTE_MANUFACTURE_TIME_MULTIPLIER], computed[ATTRIBUTE_MANUFACTURE_TIME_MULTIPLIER]),
        [ATTRIBUTE_MANUFACTURING_TIME_RESEARCH_SPEED]: toFiniteNumber(source[ATTRIBUTE_MANUFACTURING_TIME_RESEARCH_SPEED] ?? computed[ATTRIBUTE_MANUFACTURING_TIME_RESEARCH_SPEED], computed[ATTRIBUTE_MANUFACTURING_TIME_RESEARCH_SPEED]),
        [ATTRIBUTE_COPY_SPEED_PERCENT]: toFiniteNumber(source[ATTRIBUTE_COPY_SPEED_PERCENT] ?? computed[ATTRIBUTE_COPY_SPEED_PERCENT], computed[ATTRIBUTE_COPY_SPEED_PERCENT]),
        [ATTRIBUTE_MINERAL_NEED_RESEARCH_SPEED]: toFiniteNumber(source[ATTRIBUTE_MINERAL_NEED_RESEARCH_SPEED] ?? computed[ATTRIBUTE_MINERAL_NEED_RESEARCH_SPEED], computed[ATTRIBUTE_MINERAL_NEED_RESEARCH_SPEED]),
        [ATTRIBUTE_MAX_LABORATORY_SLOTS]: toFiniteNumber(source[ATTRIBUTE_MAX_LABORATORY_SLOTS] ?? computed[ATTRIBUTE_MAX_LABORATORY_SLOTS], computed[ATTRIBUTE_MAX_LABORATORY_SLOTS]),
        [ATTRIBUTE_INVENTION_RESEARCH_SPEED]: toFiniteNumber(source[ATTRIBUTE_INVENTION_RESEARCH_SPEED] ?? computed[ATTRIBUTE_INVENTION_RESEARCH_SPEED], computed[ATTRIBUTE_INVENTION_RESEARCH_SPEED]),
        [ATTRIBUTE_REACTION_TIME_MULTIPLIER]: toFiniteNumber(source[ATTRIBUTE_REACTION_TIME_MULTIPLIER] ?? computed[ATTRIBUTE_REACTION_TIME_MULTIPLIER], computed[ATTRIBUTE_REACTION_TIME_MULTIPLIER]),
        [ATTRIBUTE_REACTION_SLOT_LIMIT]: toFiniteNumber(source[ATTRIBUTE_REACTION_SLOT_LIMIT] ?? computed[ATTRIBUTE_REACTION_SLOT_LIMIT], computed[ATTRIBUTE_REACTION_SLOT_LIMIT]),
    };
    const { applyDogmaModifierGroups, getActiveImplantCharacterModifierEntries, } = getActiveImplantModifiersModule();
    applyDogmaModifierGroups(attributes, getActiveImplantCharacterModifierEntries(numericCharacterID).filter((entry) => INDUSTRY_CHARACTER_ATTRIBUTE_IDS.includes(toInt(entry && entry.modifiedAttributeID, 0))));
    return attributes;
}
...
//# sourceMappingURL=industryBrainProvider.js.map