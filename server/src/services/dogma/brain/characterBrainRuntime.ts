...
function resolveCharacterBrainTargetIDs(characterID, options: Record<string, any> = {}) {
  const numericCharacterID = toInt(characterID, 0);
  if (numericCharacterID <= 0) {
    return {
      characterID: 0,
...
function buildBootstrapCharacterBrain(characterID, version = 0, options: Record<string, any> = {}) {
...
function buildCharacterBrainGrayMatter(characterID, options: Record<string, any> = {}) {
  const targets = resolveCharacterBrainTargetIDs(characterID, options);
  const definitions = buildCharacterBrainDefinitionSet(targets.characterID);
...
function buildCharacterBrainUpdatePayload(characterID, version = null, options: Record<string, any> = {}) {
  const numericCharacterID = toInt(characterID, 0);
  if (numericCharacterID <= 0) {
    return null;
  }
...
function syncCharacterDogmaBrain(session, characterID = null, options: Record<string, any> = {}) {
...
function syncCharacterDogmaState(session, characterID = null, options: Record<string, any> = {}) {
