...
class MarketDaemonClient {
  declare _backgroundReconnectEnabled: any;
  declare _buffer: any;
  declare _connected: any;
  declare _connectingPromise: any;
  declare _lastConnectFailureLogAt: any;
  declare _nextRequestId: any;
  declare _pendingRequests: any;
  declare _reconnectTimer: any;
  declare _socket: any;
  declare connectTimeoutMs: any;
  declare enabled: any;
  declare host: any;
  declare port: any;
  declare requestTimeoutMs: any;
  declare retryDelayMs: any;
  ...
  async call(method, params: Record<string, any> = {}, options: Record<string, any> = {}) {
    if (!this.enabled) {
  ...
  async ensureConnected(options: Record<string, any> = {}) {
    if (!this.enabled) {
      throw new Error("market daemon RPC is disabled");
    }
  ...
  _logConnectFailure(error, options: Record<string, any> = {}) {
