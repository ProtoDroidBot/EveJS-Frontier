...
function normalizeFactionRecord(record = {}) {
    const factionID = normalizePositiveInteger(record.factionID, null) ||
    ...
    return {
        ...
        flatLogoWithName: typeof record.flatLogoWithName === "string"
            ? record.flatLogoWithName
            : null,
        iconID: normalizePositiveInteger(record.iconID, null),
        militiaCorporationID: normalizePositiveInteger(record.militiaCorporationID, null),
...
function getFactionRecordByCorporationID(corporationID) {
    ...
    const corporationRecords = corporationTable.records && typeof corporationTable.records === "object"
        ? corporationTable.records
        : corporationTable;
    const corporationRecord = corporationRecords[String(numericCorporationID)] ||
...
//# sourceMappingURL=factionState.js.map