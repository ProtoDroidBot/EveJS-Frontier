...
function pickTitanShowLoadout(random, config: Record<string, any> = {}) {
...
function buildSuperTitanShowConfig(scene, options: Record<string, any> = {}) {
...
function handleSuperTitanCommand(session, argumentText, options: Record<string, any> = {}) {
...
function handleSuperTitanShowCommand(session, argumentText, options: Record<string, any> = {}) {
  if (!session || !session.characterID) {
    return {
      success: false as const,
