...
function sendToCharacterIDs(characterIDs, notifyType, payloadTuple, options: Record<string, any> = {}) {
...
function listOnlineViewerCharacterIDs(event, options: Record<string, any> = {}) {
...
function notifyNewCalendarEvent(characterIDs, event, options: Record<string, any> = {}) {
  sendToCharacterIDs(
    characterIDs,
    "OnNewCalendarEvent",
    [
...
function notifyEditCalendarEvent(characterIDs, event, oldEventDateTime, options: Record<string, any> = {}) {
  sendToCharacterIDs(
    characterIDs,
    "OnEditCalendarEvent",
    [
...
function notifyRemoveCalendarEvent(characterIDs, event, isDeleted, options: Record<string, any> = {}) {
  sendToCharacterIDs(
    characterIDs,
...
function notifyExternalEventResponse(characterIDs, event, response, options: Record<string, any> = {}) {
  sendToCharacterIDs(
    characterIDs,
