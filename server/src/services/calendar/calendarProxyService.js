...
class CalendarProxyService extends BaseService {
    ...
    Handle_GetEventList(args, session) {
        return payloads.buildEventListPayload(runtime.getEventsByMonthYear(session, args && args[0], args && args[1]), session);
    }
    Handle_GetEventDetails(args, session) {
        return payloads.buildEventDetails(runtime.getEventDetails(session, args && args[0], args && args[1]));
    }
}
module.exports = CalendarProxyService;
//# sourceMappingURL=calendarProxyService.js.map