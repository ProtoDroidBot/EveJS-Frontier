...
const CONFIG_ENTRY_DEFINITIONS = [
    {
        ...
        envType: "boolean",
        description: "Automatically creates a missing account record on login using the hash the client just supplied.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Skips password-hash validation during login so any password can access an existing non-banned account.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "boolean",
        description: "Seeds empty/new characters with all published skills at level V instead of the normal racial starter skill bundle.",
        validValues: "true or false.",
    },
    {
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Lets any session manage and deliver asset-safety wraps without ownership or corporation access checks.",
        validValues: "true or false.",
    },
    {
    ...
    },
    {
        ...
        envType: "string",
        description: "Mining module name that /miner fits to the spawned hull before it boards the ship.",
    ...
    },
    {
        ...
        envType: "number",
        description: "How many copies of the configured mining module /miner attempts to fit.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Optional low-slot support module that /miner fits to create enough cargo room for the full crystal set.",
    ...
    },
    {
        ...
        envType: "number",
        description: "How many copies of the optional support module /miner attempts to fit.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Optional rig that /miner fits to expand cargo capacity while keeping the fitting valid.",
    ...
    },
    {
        ...
        envType: "number",
        description: "How many copies of the optional mining-command rig /miner attempts to fit.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "How many copies of each compatible mining crystal /miner places into the ship cargo hold.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Optional NPC profile, pool, or spawn-group query used by /npcminer when it creates the passive mining fleet. Blank falls back to security-band defaults.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile, pool, or spawn-group query used for passive mining fleets in high-security systems when no explicit override is supplied.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile, pool, or spawn-group query used for passive mining fleets in low-security systems when no explicit override is supplied.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile, pool, or spawn-group query used for passive mining fleets in null-security and wormhole systems when no explicit override is supplied.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Enables lazy normal pirate rat spawns when a player arrives at an asteroid belt. Disable to remove belt-rat spawning entirely.",
        validValues: "true or false.",
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible high-security belt arrival creates a normal pirate rat group when the belt has no active rat group.",
    ...
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible low-security belt arrival creates a normal pirate rat group when the belt has no active rat group.",
        validValues: "Number from 0.0 to 1.0.",
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible null-security belt arrival creates a normal pirate rat group when the belt has no active rat group.",
        validValues: "Number from 0.0 to 1.0.",
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Minimum time before the same empty belt can roll for another rat spawn after a player arrival check.",
    ...
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Minimum time before the same belt can spawn a replacement normal pirate rat group after its previous group was created.",
        validValues: "Non-negative duration in milliseconds.",
    },
    {
        ...
        envType: "number",
        minValue: 1,
        description: "Maximum active lazy normal pirate rat groups allowed at a single asteroid belt.",
        validValues: "Positive integer.",
    },
    {
        ...
        envType: "number",
        minValue: 1000,
        description: "Maximum distance from an asteroid belt anchor for login/arrival checks to count the player as being at that belt.",
    ...
    },
    {
        ...
        envType: "number",
        minValue: 1000,
        description: "Approximate anchor-relative distance used when placing lazy normal pirate rat groups around asteroid belts.",
        validValues: "Positive distance in meters.",
    },
    {
        ...
        envType: "boolean",
        description: "Enables rare asteroid-belt special spawns such as hauler, faction commander, and officer-style rats.",
        validValues: "true or false.",
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible empty-belt arrival creates a rare NPC hauler group instead of a normal pirate group.",
        validValues: "Number from 0.0 to 1.0.",
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible empty-belt arrival creates a faction commander spawn instead of a normal pirate group.",
        validValues: "Number from 0.0 to 1.0.",
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible deep nullsec pirate-home belt arrival creates an officer-style rare spawn.",
        validValues: "Number from 0.0 to 1.0.",
    },
    {
        ...
        minValue: -1,
        maxValue: 1,
        description: "Maximum true security status eligible for non-home-region officer-style asteroid-belt spawns.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Restricts officer-style asteroid-belt spawns to the matching pirate faction's home region.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "boolean",
        description: "Enables rare null-security asteroid-belt capital NPC spawns such as pirate dreadnoughts.",
        validValues: "true or false.",
    },
    {
        ...
        minValue: 0,
        maxValue: 1,
        description: "Chance that an eligible empty null-security belt arrival creates a rare pirate capital spawn instead of normal belt rats.",
        validValues: "Number from 0.0 to 1.0.",
    },
    {
        ...
        minValue: -1,
        maxValue: 1,
        description: "Maximum true security status eligible for rare asteroid-belt capital spawns. Capital spawns are still null-security only.",
        validValues: "Number from -1.0 to 1.0.",
    },
    {
        ...
        envType: "string",
        description: "Comma-separated capital classes allowed in rare asteroid-belt capital spawns.",
    ...
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Maximum active rare asteroid-belt capital groups allowed in one solar-system scene. Use 0 for no system-wide cap.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Default repetition count used by /npcminer when no explicit amount is provided. Pool/profile queries treat this as a hull count, while spawn-group queries repeat the full authored group.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Optional NPC profile, pool, or spawn-group query used for the transient hauler wing attached to mining fleets. Blank falls back to security-band defaults.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile, pool, or spawn-group query used for transient mining haulers in high-security systems when no explicit override is supplied.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile, pool, or spawn-group query used for transient mining haulers in low-security systems when no explicit override is supplied.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile, pool, or spawn-group query used for transient mining haulers in null-security and wormhole systems when no explicit override is supplied.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Default hauler hull count attached to /npcminer fleets and startup mining fleets.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Radius around the target ship used when mining NPCs finish their warp-in.",
        validValues: "Positive distance in meters.",
    },
    {
        ...
        envType: "string",
        description: "NPC profile or spawn-pool query used by /npcmineraggro when the response fleet is called.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Fallback spawn-pool ID passed into the mining-response warp command when no query is supplied.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Fallback profile ID used when the configured mining response pool cannot resolve a direct match.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Default hull count used by /npcmineraggro when no explicit response amount is supplied.",
        validValues: "Positive integer up to the GM command safety cap.",
    },
    {
        ...
        envType: "boolean",
        description: "Enables standings-aware response planning for transient mining NPC fleets when they are aggressed.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "number",
        description: "Fallback hostile standing threshold used by mining NPC fleets when the NPC profile does not provide explicit response thresholds.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Fallback friendly standing threshold used by mining NPC fleets when the NPC profile does not provide explicit response thresholds.",
        validValues: "Number between -10 and 10.",
    },
    {
        ...
        envType: "string",
        description: "Optional NPC profile or pool used when a mining fleet is aggressed by a character with friendly standings.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Response hull count used for friendly-standing aggressors after a mining fleet retreats.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "string",
        description: "NPC profile or pool used when a mining fleet is aggressed by a neutral-standing character.",
        validValues: 'NPC profile or pool ID such as "npc_laser_hostiles".',
    },
    {
        ...
        envType: "number",
        description: "Response hull count used for neutral-standing aggressors after a mining fleet retreats.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "string",
        description: "NPC profile or pool used when a mining fleet is aggressed by a hostile-standing character.",
        validValues: 'NPC profile or pool ID such as "npc_laser_hostiles".',
    },
    {
        ...
        envType: "number",
        description: "Response hull count used for hostile-standing aggressors after a mining fleet retreats.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Minimum delay between mining-fleet response deployments so repeat aggression during a single exchange does not spam extra wings.",
        validValues: "Non-negative duration in milliseconds.",
    },
    {
        ...
        envType: "number",
        description: "How long mining fleets remember aggression on their miner or hauler hulls before the event is considered stale.",
        validValues: "Non-negative duration in milliseconds.",
    },
    {
        ...
        envType: "number",
        description: "How long the transient response wing remains deployed after the last aggression before it retreats or despawns.",
        validValues: "Non-negative duration in milliseconds.",
    },
    {
        ...
        envType: "number",
        description: "Warp ingress duration used by the mining NPC warp-in and retreat helpers.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Enables the mining runtime, asteroid depletion state, and mining scan service.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "number",
        description: "Maximum range used when the mining scan manager returns asteroid scan tuples to the client.",
        validValues: "Positive distance in meters.",
    },
    {
        ...
        envType: "number",
        description: "Radius-to-volume scale used when estimating authoritative asteroid quantities for generated belt rocks.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Minimum generated asteroid volume used by the mining runtime for generated belt rocks.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Maximum generated asteroid volume used by the mining runtime for generated belt rocks.",
        validValues: "Positive number of cubic meters.",
    },
    {
        ...
        envType: "boolean",
        description: "Adds deterministic runtime ice fields to space scenes so ice harvesters and ore-hold routing have live non-moon content to work against.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "boolean",
        description: "Adds deterministic runtime gas fields to space scenes so gas harvesters have authored-on-startup content without relying on GM commands.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated ice-field anchors created in each high-security system scene when ice runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated ice-field anchors created in each low-security system scene when ice runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated ice-field anchors created in each null-security system scene when ice runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated ice-field anchors created in each wormhole system scene when ice runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of high-security systems that should carry generated ice fields in the universe-seeded Phase 3 mining pool.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of low-security systems that should carry generated ice fields in the universe-seeded Phase 3 mining pool.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of null-security systems that should carry generated ice fields in the universe-seeded Phase 3 mining pool.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of wormhole systems that should carry generated ice fields in the universe-seeded Phase 3 mining pool.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Lifetime in minutes for universe-seeded generated ice site slots before they rotate in place to the next deterministic field definition.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Number of generated gas-field anchors created in each high-security system scene when gas runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated gas-field anchors created in each low-security system scene when gas runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated gas-field anchors created in each null-security system scene when gas runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Number of generated gas-field anchors created in each wormhole system scene when gas runtime content is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Distance applied when deterministic ice/gas site anchors are offset from their source belt or celestial.",
        validValues: "Positive distance in meters.",
    },
    {
        ...
        envType: "number",
        description: "Radius of the generated runtime ice and gas fields around each deterministic site anchor.",
        validValues: "Positive distance in meters.",
    },
    {
        ...
        envType: "number",
        description: "How many mineable ice chunks each generated ice field contains.",
        validValues: "Positive integer.",
    },
    {
        ...
        envType: "number",
        description: "How many mineable gas clouds each generated gas field contains.",
        validValues: "Positive integer.",
    },
    {
        ...
        envType: "number",
        description: "Minimum radius ratio preserved while an asteroid is being depleted before it is removed from the scene.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Lets /npcminer fleets automatically lock asteroids, approach, activate miners, and deplete rocks.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "number",
        description: "Polling interval for the mining NPC fleet controller.",
        validValues: "Positive duration in milliseconds.",
    },
    {
        ...
        envType: "number",
        description: "How much margin NPC miners keep inside mining range before they stop approaching and start mining.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Orbit distance used by NPC miners once they are in range of their asteroid target.",
        validValues: "Positive distance in meters.",
    },
    {
    ...
    },
    {
        ...
        envType: "number",
        description: "Fraction of miner cargo fill at which the transient NPC hauler choreography triggers.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Landing radius used when mining fleet haulers warp to collect ore from the miner wing.",
        validValues: "Positive distance in meters.",
    },
    {
        ...
        envType: "number",
        description: "Delay budget used by the transient NPC hauler wing between arrival and hauling completion.",
        validValues: "Positive duration in milliseconds.",
    },
    {
    ...
    },
    {
        ...
        envType: "number",
        description: "Optional delay after /npcmineraggro or /npcminerpanic before transient mining fleets auto-resume mining.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Configured cargo-capacity budget used by the mining NPC controller when deciding when to call haulers.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Configured cargo-capacity budget used by the transient mining NPC hauler wing.",
        validValues: "Positive cargo capacity in cubic meters.",
    },
    {
        ...
        envType: "boolean",
        description: "Recreates transient mining fleets from config when matching solar-system scenes are created at startup/runtime.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "string",
        description: "Comma-separated solar system IDs that should receive transient startup mining fleets. Blank means all loaded scenes.",
    ...
    },
    {
        ...
        envType: "number",
        description: "How many transient mining fleets to recreate per matching system scene during startup.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Miner hull count per transient startup mining fleet.",
        validValues: "Positive integer.",
    },
    {
        ...
        envType: "number",
        description: "Hauler hull count per transient startup mining fleet.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "string",
        description: "NPC profile or pool used when config-driven transient startup mining fleets are recreated.",
    ...
    },
    {
        ...
        envType: "string",
        description: "NPC profile or pool used for the transient hauler wing of startup mining fleets.",
        validValues: 'NPC profile or pool ID such as "npc_mining_ops".',
    },
    {
        ...
        envType: "number",
        description: "Structure-side base reprocessing efficiency used by the mining industry services until per-structure rig bonuses are modeled.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Structure-side base gas decompression efficiency used by structureCompressionMgr.",
        validValues: "Fraction between 0 and 1.",
    },
    {
        ...
        envType: "number",
        description: "Maximum range used by the in-space compression service when validating a compression facility ball.",
        validValues: "Positive distance in meters.",
    },
    {
    ...
    },
    {
        ...
        envType: "number",
        description: "Boot version reported to the client during the login handshake.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Client build number reported to the client during the login handshake.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Birthday value used by the handshake version checks.",
    ...
    },
    {
        ...
        envType: "number",
        description: "MachoNet protocol version reported during session bootstrap.",
        validValues: "Integer matching your client build.",
    },
    {
        key: "projectCodename",
        ...
        description: "Project codename reported to the client during startup.",
        validValues: "String matching the client boot codename; leave the default unless your client build requires another value.",
    },
    {
        key: "projectRegion",
        defaultValue: "ccp",
        ...
        envType: "string",
        description: "Project region reported to the client during startup.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Full project version string reported to the client during startup.",
        validValues: 'String matching your client boot version, for example "V24.01@ccp".',
    },
    {
        ...
        description: "Selects narrowly scoped client-protocol compatibility behavior.",
    ...
    },
    {
        ...
        validValues: 'A known Carbon login-status label such as "/Carbon/MachoNet/ServerStatus/OK" or "/Carbon/MachoNet/ServerStatus/StartingUp".',
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Progress/countdown value injected when serverStatusLabel is /Carbon/MachoNet/ServerStatus/StartingUp.",
    ...
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Limit value injected when serverStatusLabel is /Carbon/MachoNet/ServerStatus/ProxyFullWithLimit.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Cluster user count reported during login-status and handshake flows.",
        validValues: "Non-negative integer.",
    },
    {
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Exposes HyperNetKillSwitch through machoNet global config so the client can gate HyperNet availability.",
        validValues: "true or false.",
    },
    {
    ...
    },
    {
        ...
        envType: "number",
        description: "Character ID used as the seller/source hangar for optional HyperNet startup seeding.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Allows the HyperNet seed manager to restock GM seed inventory before creating demo listings.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "number",
        description: "Minimum number of seeded ship raffles the startup seed manager targets when HyperNet seeding is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Maximum number of seeded ship raffles the startup seed manager targets when HyperNet seeding is enabled.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Minimum number of seeded non-ship raffles the startup seed manager targets when HyperNet seeding is enabled.",
        validValues: "Non-negative integer.",
    },
    {
        ...
        envType: "number",
        description: "Maximum number of seeded non-ship raffles the startup seed manager targets when HyperNet seeding is enabled.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Controls how much the server writes to the log output.",
        validValues: "0 = silent, 1 = normal server logging, 2 = verbose debug logging.",
    },
    {
        ...
        envType: "boolean",
        description: "When verbose debug logging is enabled, also dumps decoded packet payload previews and outgoing packet hex summaries on hot network paths.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "string",
        description: "Local interface used by the main game TCP listener. Keep this on 127.0.0.1 unless a container or similarly isolated network boundary provides the external localhost-only restriction.",
    ...
    },
    {
        ...
        envType: "number",
        description: "TCP port used by the main game server listener.",
    ...
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Idle time before the OS starts sending TCP keep-alive probes on a game client socket.",
        validValues: "Non-negative duration in milliseconds.",
    },
    {
    ...
    },
    {
        ...
        envType: "string",
        description: "Host name or IP address the client should use when connecting to the main game TCP listener.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Enables the external market daemon connection and expiry poller.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "string",
        description: "Host name or IP address used by the main server to reach the standalone Rust market daemon RPC listener.",
    ...
    },
    {
        ...
        envType: "number",
        description: "TCP port used by the main server when forwarding marketProxy calls to the standalone market daemon RPC listener.",
        validValues: "Available TCP port number.",
    },
    {
        ...
        envType: "number",
        description: "How long the main server waits for the market daemon TCP connection to open before treating it as unavailable.",
    ...
    },
    {
        ...
        envType: "number",
        description: "How long an individual forwarded market RPC call may take before the main server fails it.",
        validValues: "Positive integer duration in milliseconds.",
    },
    {
        ...
        envType: "number",
        description: "Delay between background reconnect attempts when the main server is waiting for the standalone market daemon to come online.",
        validValues: "Positive integer duration in milliseconds.",
    },
    {
    ...
    },
    {
        ...
        envType: "string",
        description: "Base URL sent to the client for image and icon requests.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Host or bind address the local image HTTP server listens on.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Base URL used to redirect supported microservice calls away from CCP.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Server-side HTTP base URL where the EveJS microservice and public-gateway bridge listens for forwarded helper traffic.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Host or bind address the EveJS microservice and public-gateway bridge listens on.",
        validValues: 'Host name or IP string such as "127.0.0.1" or "0.0.0.0".',
    },
    {
        ...
        envType: "string",
        description: "Host or bind address the Redshift TiDi monitor API listens on.",
        validValues: 'Host name or IP string such as "127.0.0.1" or "0.0.0.0".',
    },
    {
        ...
        envType: "number",
        description: "TCP port used by the Redshift TiDi monitor API.",
        validValues: "Available TCP port number.",
    },
    {
        key: "proxyBlockedHosts",
        defaultValue: "api.ipify.org,sentry.io,.sentry.io,google-analytics.com,.google-analytics.com",
        envVar: "EVEJS_PROXY_BLOCKED_HOSTS",
        envType: "string",
        description: "Comma-separated hostnames or dot-prefix suffixes the local HTTP proxy should block instead of forwarding off-box.",
        validValues: 'Comma-separated host patterns, for example "api.ipify.org,sentry.io,.sentry.io,google-analytics.com,.google-analytics.com".',
    },
    {
        ...
        envType: "string",
        description: "Comma-separated extra hostnames or suffix patterns the local HTTP proxy may forward off-box when they are not handled by the built-in EveJS gateway intercepts.",
        validValues: 'Comma-separated host patterns, for example "images.example.com,.examplecdn.net", or blank to allow only EveJS-handled endpoints.',
    },
    {
        ...
        envType: "string",
        description: 'Controls what the local HTTP proxy does with proxied hosts that are neither EveJS-intercepted nor explicitly allow-listed. "block" is the safe default that suppresses telemetry and stray outbound traffic; "forward" restores the old transparent pass-through behavior.',
    ...
    },
    {
        ...
        envType: "string",
        description: "Local interface used by the XMPP chat listener. Keep this on 127.0.0.1 unless a container or similarly isolated network boundary provides the external localhost-only restriction.",
        validValues: 'Bind address such as "127.0.0.1" or "0.0.0.0".',
    },
    {
        key: "xmppServerPort",
        ...
        envType: "number",
        description: "TCP port used by the local XMPP chat stub server.",
        validValues: "Available TCP port number.",
    },
    {
        key: "xmppConnectHost",
        ...
        envType: "string",
        description: "Host name or IP address returned to the client for the XMPP chat connection target.",
    ...
    },
    {
        ...
        envType: "string",
        description: "XMPP domain used for bare JIDs and chat identity values.",
    ...
    },
    {
        ...
        envType: "string",
        description: "XMPP conference domain used for chat room JIDs.",
    ...
    },
    {
        ...
        envType: "string",
        description: "Shared secret that gates the /playerconnect/* helper endpoints (health ping + CA download) used by the PlayerConnect bundle. When empty, those endpoints are disabled.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Enables the stubbed omega-license path for modern eve_public flows.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "boolean",
        description: "Enables the cache-backed New Eden Store, legacy storeManager catalog, and public payment surfaces.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "boolean",
        description: "Enables the legacy FastCheckoutService path the client uses for in-game PLEX purchases.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "boolean",
        description: "Lets cash purchase attempts succeed locally and grant the selected offer without touching a real payment processor.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "string",
        description: "Response string returned by FastCheckoutService.BuyOffer when the local fake purchase completes.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Forces the client down the China-funnel branch of fast checkout testing.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "string",
        description: "Optional URL the client opens when testing the external buy-plex-offer path.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Controls whether the client uses shell execute for external PLEX-offer purchase URLs during fast checkout tests.",
        validValues: "true or false.",
    },
    {
        ...
        envType: "number",
        description: "TCP port used by the local New Eden Store editor GUI under scripts/newedenstore.",
        validValues: "Available TCP port number.",
    },
    {
        ...
        envType: "number",
        description: "Conversion rate used by the store purchase helpers when translating stored PLEX offer pricing into whole PLEX debits.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Tax rate in basis points applied to fake cash CostRequest calculations for public payment flows.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Maximum number of completed New Eden Store purchases retained in the cache-backed runtime log.",
        validValues: "Positive integer.",
    },
    {
        ...
        envType: "boolean",
        description: "Enables the 15-day daily login reward campaign.",
        validValues: "true or false.",
    },
    {
        ...
        validValues: "Non-empty JSON array of objects with positive integer typeID and quantity fields.",
    ...
    },
    {
        ...
        envType: "number",
        description: "How long GM and testing space debris persists before cleanup.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Enables automatic tick-lateness-based time dilation scaling.",
        validValues: "true or false.",
    },
    {
    ...
    },
    {
        ...
        minValue: 10,
        maxValue: 1000,
        description: "Fastest allowed adaptive space-runtime cadence in milliseconds. 50ms is 20 ticks per second.",
    ...
    },
    {
        ...
        minValue: 10,
        maxValue: 5000,
        description: "Slowest allowed adaptive space-runtime cadence in milliseconds. 250ms is 4 ticks per second.",
    ...
    },
    {
        ...
        minValue: 1,
        maxValue: 1000,
        description: "Milliseconds added to or removed from the tick interval on each resource sample that crosses a threshold.",
    ...
    },
    {
        ...
        minValue: 250,
        maxValue: 60000,
        description: "Minimum time between process CPU and memory samples used by the adaptive tick-rate controller.",
    ...
    },
    {
        ...
        minValue: 0,
        maxValue: 100,
        description: "Process CPU level at or above which the controller lowers the tick rate.",
    ...
    },
    {
        ...
        minValue: 0,
        maxValue: 100,
        description: "Process RSS level at or below which memory is considered to have headroom.",
    ...
    },
    {
        ...
        minValue: 0,
        maxValue: 100,
        description: "Process RSS level at or above which the controller lowers the tick rate.",
    ...
    },
    {
        ...
        envType: "boolean",
        description: "Enables automatic Crimewatch-driven CONCORD response to criminal actions in high-security space.",
        validValues: "true or false.",
    },
    {
    ...
    },
    {
        ...
        minValue: 0,
        exclusiveMinValue: true,
        description: "Hull temperature at which the Frontier heat effect becomes active and its damage-delay timer starts.",
    ...
    },
    {
        ...
        minValue: 0,
        exclusiveMinValue: true,
        description: "Fraction of a ship's nominal maximum feralization that activates the feralization effect and starts its damage-delay timer.",
    ...
    },
    {
        ...
        minValue: 0,
        exclusiveMinValue: true,
        description: "Fraction of a ship's nominal maximum temporal drift that activates the temporal-drift effect and starts its damage-delay timer.",
        validValues: "Positive ratio. 1 activates at 100% of nominal maximum; 0.5 activates at 50%.",
    },
    {
    ...
    },
    {
        ...
        envType: "number",
        minValue: 0,
        description: "Shell vitality removed per second by each environmental effect after its configured damage delay.",
    ...
    },
    {
        ...
        minValue: 0,
        exclusiveMinValue: true,
        description: "Surface-distance radius around Crude Matter rifts over which temporal drift is generated.",
    ...
    },
    {
        ...
        minValue: 0,
        exclusiveMinValue: true,
        description: "Multiplier applied to nominal maximum temporal drift at the center of a Crude Matter rift.",
    ...
    },
    {
        ...
        envType: "number",
        description: "Proxy node ID reported to the client and used when generating bound object IDs.",
        validValues: "Integer node ID. 65450 matches the traditional 0xFFAA value.",
    },
];
const CONFIG_ENTRY_DEFINITIONS_BY_KEY = new Map(CONFIG_ENTRY_DEFINITIONS.map((entry) => [entry.key, entry]));
const defaults = Object.fromEntries(CONFIG_ENTRY_DEFINITIONS.map((entry) => [entry.key, entry.defaultValue]));
...
function validateAllowedValue(entry, value) {
    if (typeof entry?.minValue === "number" &&
        ...
        throw new Error(`${entry.key} must be ${entry.exclusiveMinValue === true ? "greater than" : "at least"} ${entry.minValue}.`);
    }
    ...
    if (Array.isArray(entry?.allowedValues) &&
        ...
        throw new Error(`${entry.key} must be one of ${entry.allowedValues
...
function loadEnvConfig() {
    return withDefinedEntries(Object.fromEntries(CONFIG_ENTRY_DEFINITIONS.map((entry) => [
        entry.key,
        parseEnvValue(entry),
    ])));
}
function normalizePersistedConfig(rawConfig = {}) {
    const normalized = {};
    const hasRewardArray = Object.prototype.hasOwnProperty.call(rawConfig || {}, "dailyLoginRewards");
    if (!hasRewardArray) {
        ...
        if (Number.isInteger(legacyTypeID) && legacyTypeID > 0 &&
    ...
    const normalizedProjectCodename = String(normalized.projectCodename || "").trim().toLowerCase();
    if (normalizedProjectCodename === "crucible" ||
    ...
    if (["V23.02@evejs", "V23.02@ccp"].includes(String(normalized.projectVersion || "").trim())) {
...
function buildCommentedConfigText(nextConfig = {}) {
    ...
    entries.forEach(([key, value], index) => {
        ...
        lines.push("");
        lines.push(...buildConfigPropertyLines(key, value, index === entries.length - 1));
...
const sharedConfig = syncConfigFileDefaults(sharedConfigPath, sharedRawConfig);
const localConfig = syncConfigFileDefaults(localConfigPath, localRawConfig, {
...
function getConfigStateSnapshot() {
    ...
    const sources = Object.fromEntries(CONFIG_ENTRY_DEFINITIONS.map((entry) => {
...
function buildValidatedConfigValues(rawValues = {}, options = {}) {
    ...
    const baseValues = options.baseValues && typeof options.baseValues === "object"
        ? options.baseValues
        : snapshot.fileConfig;
    const nextValues = {};
    for (const entry of CONFIG_ENTRY_DEFINITIONS) {
        const candidateValue = Object.prototype.hasOwnProperty.call(rawValues, entry.key)
            ? rawValues[entry.key]
            : baseValues[entry.key];
        nextValues[entry.key] = coerceConfigValue(entry, candidateValue);
    }
    if (nextValues.frontierEnvironmentalHeatCriticalThresholdKelvin <=
        nextValues.frontierEnvironmentalHeatWarningThresholdKelvin) {
        throw new Error("frontierEnvironmentalHeatCriticalThresholdKelvin must be greater than " +
            "frontierEnvironmentalHeatWarningThresholdKelvin.");
    }
    if (nextValues.frontierScanningResolutionRangeMeters >
        nextValues.frontierScanningDetectionRangeMeters) {
        throw new Error("frontierScanningResolutionRangeMeters must be less than or equal to " +
            "frontierScanningDetectionRangeMeters.");
    }
    if (nextValues.adaptiveTickRateMinIntervalMs >
        nextValues.adaptiveTickRateMaxIntervalMs) {
        throw new Error("adaptiveTickRateMinIntervalMs must be less than or equal to " +
            "adaptiveTickRateMaxIntervalMs.");
    }
    if (nextValues.adaptiveTickRateInitialIntervalMs <
        nextValues.adaptiveTickRateMinIntervalMs ||
        nextValues.adaptiveTickRateInitialIntervalMs >
            nextValues.adaptiveTickRateMaxIntervalMs) {
        throw new Error("adaptiveTickRateInitialIntervalMs must be within the configured " +
            "adaptive tick-rate interval bounds.");
    }
    if (nextValues.adaptiveTickRateCpuLowPercent >=
        nextValues.adaptiveTickRateCpuHighPercent) {
        throw new Error("adaptiveTickRateCpuLowPercent must be less than " +
            "adaptiveTickRateCpuHighPercent.");
    }
    if (nextValues.adaptiveTickRateMemoryLowPercent >=
        nextValues.adaptiveTickRateMemoryHighPercent) {
        throw new Error("adaptiveTickRateMemoryLowPercent must be less than " +
...
function saveLocalConfig(rawValues = {}) {
    ...
    const preservedCustomEntries = Object.fromEntries(Object.entries(currentLocalRawConfig).filter(([key]) => !CONFIG_ENTRY_DEFINITIONS_BY_KEY.has(key) && !REMOVED_CONFIG_KEYS.has(key)));
    const nextKnownValues = buildValidatedConfigValues(rawValues);
    syncConfigFileDefaults(localConfigPath, {
