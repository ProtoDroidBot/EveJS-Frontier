...
const { ATTRIBUTE_FUEL_CAPACITY, ATTRIBUTE_FUEL_CHARGE, collectFuelSourceStacks, getShipFuelCharge, loadFuelIntoShipTank, normalizeRequestedFuelItemIDs, } = require("../src/services/frontier/fuelTankRuntime");
...
function fakeTypeResolver(overrides = {}) {
    ...
    return (typeID) => groups[typeID] === undefined ? null : { typeID, groupID: groups[typeID] };
}
