...
test("shell rename is owner-scoped, client-bounded, persisted, and notified", () => {
    const grant = itemStore.grantItemToCharacterLocation(CHARACTER_ID, CHARACTER_ID, itemStore.ITEM_FLAGS.HANGAR, ShellManagerService._testing.DEFAULT_SHELL_TYPE_ID, 1, {
